...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Zs(e,t,n){let r=new Float32Array(Ls),i=new W(0,1,0);return new Ja({name:`SphericalGaussianBlur`,defines:{n:Ls,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:ec(),fragmentShader:`
	...
	`}var tc=class extends nn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new wa(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`+e.fragmentShader.replace(`#include <color_fragment>`,`#include <color_fragment>
        ...
        diffuseColor.rgb = mix(diffuseColor.rgb, vec3(0.34,0.018,0.028), appearanceWound*(0.48+streak*woundPatch*0.52));`)},t.customProgramCacheKey=()=>`appearance-wounds-v1`,t.needsUpdate=!0})}update(e,n){let i=Math.max(0,Math.min(1,e.hp/e.maxHp)),a=Math.max(0,Math.min(1,e.energy/100));this.wound.value=Math.min(1,Math.max(0,(.5-i)*2.7));let o=r[t(e)].color,s=e.guard>0||e.flash>0||e.frozen>0||e.burning>0||e.shocked>0;this.group.visible=e.hp>0,this.bands.forEach((e,t)=>{e.rotation.z=n*(t?-.7:.6);let r=e.material;r.color.setHex(o),r.opacity=a>=1?s?.15:.55:0}),this.sparks.forEach((e,t)=>{let r=n*.45+t/6,i=r%1,c=r*Math.PI*2;e.position.set(Math.cos(c)*.4,.65+i*1.1,Math.sin(c)*.4);let l=e.material;l.color.setHex(o),l.opacity=a*(a>=.4?.7:.3)*Math.sin(i*Math.PI)*(s?.25:1)})}};function Hu(e,t){let n=Math.hypot(e,t),r=Math.min(1,Math.max(0,(n-.12)/.88));return{x:n?e/n*r*2.4:0,y:n?t/n*r*2.8:0}}var Uu=e=>1-Math.exp(-8*Math.max(0,Math.min(e,.1)));function Wu(e,t=!1){let n=e[0].index!==null,r=new Set(Object.keys(e[0].attributes)),i=new Set(Object.keys(e[0].morphAttributes)),a={},o={},s=e[0].morphTargetsRelative,c=new Fr,l=0;for(let u=0;u<e.length;++u){let d=e[u],f=0;if(n!==(d.index!==null))return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. All geometries must have compatible attributes; make sure index attribute exists among all geometries, or in none of them.`),null;for(let e in d.attributes){if(!r.has(e))return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. All geometries must have compatible attributes; make sure "`+e+`" attribute exists among all geometries, or in none of them.`),null;a[e]===void 0&&(a[e]=[]),a[e].push(d.attributes[e]),f++}if(f!==r.size)return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. Make sure all geometries have the same number of attributes.`),null;if(s!==d.morphTargetsRelative)return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. .morphTargetsRelative must be consistent throughout all geometries.`),null;for(let e in d.morphAttributes){if(!i.has(e))return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`.  .morphAttributes must be consistent throughout all geometries.`),null;o[e]===void 0&&(o[e]=[]),o[e].push(d.morphAttributes[e])}if(t){let e;if(n)e=d.index.count;else if(d.attributes.position!==void 0)e=d.attributes.position.count;else return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. The geometry must have either an index or a position attribute`),null;c.addGroup(l,e,u),l+=e}}if(n){let t=0,n=[];for(let r=0;r<e.length;++r){let i=e[r].index;for(let e=0;e<i.count;++e)n.push(i.getX(e)+t);t+=e[r].attributes.position.count}c.setIndex(n)}for(let e in a){let t=Gu(a[e]);if(!t)return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed while trying to merge the `+e+` attribute.`),null;c.setAttribute(e,t)}for(let e in o){let t=o[e][0].length;if(t!==0){c.morphAttributes=c.morphAttributes||{},c.morphAttributes[e]=[];for(let n=0;n<t;++n){let t=[];for(let r=0;r<o[e].length;++r)t.push(o[e][r][n]);let r=Gu(t);if(!r)return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed while trying to merge the `+e+` morphAttribute.`),null;c.morphAttributes[e].push(r)}}}return c}function Gu(e){let t,n,r,i=-1,a=0;for(let o=0;o<e.length;++o){let s=e[o];if(t===void 0&&(t=s.array.constructor),t!==s.array.constructor)return console.error(`THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.array must be of consistent array types across matching attributes.`),null;if(n===void 0&&(n=s.itemSize),n!==s.itemSize)return console.error(`THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.itemSize must be consistent across matching attributes.`),null;if(r===void 0&&(r=s.normalized),r!==s.normalized)return console.error(`THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.normalized must be consistent across matching attributes.`),null;if(i===-1&&(i=s.gpuType),i!==s.gpuType)return console.error(`THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.gpuType must be consistent across matching attributes.`),null;a+=s.count*n}let o=new t(a),s=new xr(o,n,r),c=0;for(let t=0;t<e.length;++t){let r=e[t];if(r.isInterleavedBufferAttribute){let e=c/n;for(let t=0,i=r.count;t<i;t++)for(let i=0;i<n;i++){let n=r.getComponent(t,i);s.setComponent(t+e,i,n)}}else o.set(r.array,c);c+=r.count*n}return i!==void 0&&(s.gpuType=i),s}function Ku(e,t){if(t===0)return console.warn(`THREE.BufferGeometryUtils.toTrianglesDrawMode(): Geometry already defined as triangles.`),e;if(t===2||t===1){let n=e.getIndex();if(n===null){let t=[],r=e.getAttribute(`position`);if(r!==void 0){for(let e=0;e<r.count;e++)t.push(e);e.setIndex(t),n=e.getIndex()}else return console.error(`THREE.BufferGeometryUtils.toTrianglesDrawMode(): Undefined position attribute. Processing not possible.`),e}let r=n.count-2,i=[];if(t===2)for(let e=1;e<=r;e++)i.push(n.getX(0)),i.push(n.getX(e)),i.push(n.getX(e+1));else for(let e=0;e<r;e++)e%2==0?(i.push(n.getX(e)),i.push(n.getX(e+1)),i.push(n.getX(e+2))):(i.push(n.getX(e+2)),i.push(n.getX(e+1)),i.push(n.getX(e)));i.length/3!==r&&console.error(`THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unable to generate correct amount of triangles.`);let a=e.clone();return a.setIndex(i),a.clearGroups(),a}else return console.error(`THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unknown draw mode:`,t),e}function qu(e){let t=new Map,n=new Map,r=e.clone();return Ju(e,r,function(e,r){t.set(r,e),n.set(e,r)}),r.traverse(function(e){if(!e.isSkinnedMesh)return;let r=e,i=t.get(e),a=i.skeleton.bones;r.skeleton=i.skeleton.clone(),r.bindMatrix.copy(i.bindMatrix),r.skeleton.bones=a.map(function(e){return n.get(e)}),r.bind(r.skeleton,r.bindMatrix)}),r}function Ju(e,t,n){n(e,t);for(let r=0;r<e.children.length;r++)Ju(e.children[r],t.children[r],n)}var Yu=class extends To{constructor(e){super(e),this.dracoLoader=null,this.ktx2Loader=null,this.meshoptDecoder=null,this.pluginCallbacks=[],this.register(function(e){return new td(e)}),this.register(function(e){return new nd(e)}),this.register(function(e){return new dd(e)}),this.register(function(e){return new fd(e)}),this.register(function(e){return new pd(e)}),this.register(function(e){return new id(e)}),this.register(function(e){return new ad(e)}),this.register(function(e){return new od(e)}),this.register(function(e){return new sd(e)}),this.register(function(e){return new ed(e)}),this.register(function(e){return new cd(e)}),this.register(function(e){return new rd(e)}),this.register(function(e){return new ud(e)}),this.register(function(e){return new ld(e)}),this.register(function(e){return new Qu(e)}),this.register(function(e){return new md(e,$.EXT_MESHOPT_COMPRESSION)}),this.register(function(e){return new md(e,$.KHR_MESHOPT_COMPRESSION)}),this.register(function(e){return new hd(e)})}load(e,t,n,r){let i=this,a;if(this.resourcePath!==``)a=this.resourcePath;else if(this.path!==``){let t=$o.extractUrlBase(e);a=$o.resolveURL(t,this.path)}else a=$o.extractUrlBase(e);this.manager.itemStart(e);let o=function(t){r?r(t):console.error(t),i.manager.itemError(e),i.manager.itemEnd(e)},s=new Oo(this.manager);s.setPath(this.path),s.setResponseType(`arraybuffer`),s.setRequestHeader(this.requestHeader),s.setWithCredentials(this.withCredentials),s.load(e,function(n){try{i.parse(n,a,function(n){t(n),i.manager.itemEnd(e)},o)}catch(e){o(e)}},n,o)}setDRACOLoader(e){return this.dracoLoader=e,this}setKTX2Loader(e){return this.ktx2Loader=e,this}setMeshoptDecoder(e){return this.meshoptDecoder=e,this}register(e){return this.pluginCallbacks.indexOf(e)===-1&&this.pluginCallbacks.push(e),this}unregister(e){return this.pluginCallbacks.indexOf(e)!==-1&&this.pluginCallbacks.splice(this.pluginCallbacks.indexOf(e),1),this}parse(e,t,n,r){let i,a={},o={},s=new TextDecoder;if(typeof e==`string`)i=JSON.parse(e);else if(e instanceof ArrayBuffer)if(s.decode(new Uint8Array(e,0,4))===gd){try{a[$.KHR_BINARY_GLTF]=new yd(e)}catch(e){r&&r(e);return}i=JSON.parse(a[$.KHR_BINARY_GLTF].content)}else i=JSON.parse(s.decode(e));else i=e;if(i.asset===void 0||i.asset.version[0]<2){r&&r(Error(`THREE.GLTFLoader: Unsupported asset. glTF versions >=2.0 are supported.`));return}let c=new Gd(i,{path:t||this.resourcePath||``,crossOrigin:this.crossOrigin,requestHeader:this.requestHeader,manager:this.manager,ktx2Loader:this.ktx2Loader,meshoptDecoder:this.meshoptDecoder});c.fileLoader.setRequestHeader(this.requestHeader);for(let e=0;e<this.pluginCallbacks.length;e++){let t=this.pluginCallbacks[e](c);t.name||console.error(`THREE.GLTFLoader: Invalid plugin found: missing name`),o[t.name]=t,a[t.name]=!0}if(i.extensionsUsed)for(let e=0;e<i.extensionsUsed.length;++e){let t=i.extensionsUsed[e],n=i.extensionsRequired||[];switch(t){case $.KHR_MATERIALS_UNLIT:a[t]=new $u;break;case $.KHR_DRACO_MESH_COMPRESSION:a[t]=new bd(i,this.dracoLoader);break;case $.KHR_TEXTURE_TRANSFORM:a[t]=new xd;break;case $.KHR_MESH_QUANTIZATION:a[t]=new Sd;break;default:n.indexOf(t)>=0&&o[t]===void 0&&console.warn(`THREE.GLTFLoader: Unknown extension "`+t+`".`)}}c.setExtensions(a),c.setPlugins(o),c.parse(n,r)}parseAsync(e,t){let n=this;return new Promise(function(r,i){n.parse(e,t,r,i)})}};function Xu(){let e={};return{get:function(t){return e[t]},add:function(t,n){e[t]=n},remove:function(t){delete e[t]},removeAll:function(){e={}}}}function Zu(e,t,n){let r=e.json.materials[t];return r.extensions&&r.extensions[n]?r.extensions[n]:null}var $={KHR_BINARY_GLTF:`KHR_binary_glTF`,KHR_DRACO_MESH_COMPRESSION:`KHR_draco_mesh_compression`,KHR_LIGHTS_PUNCTUAL:`KHR_lights_punctual`,KHR_MATERIALS_CLEARCOAT:`KHR_materials_clearcoat`,KHR_MATERIALS_DISPERSION:`KHR_materials_dispersion`,KHR_MATERIALS_IOR:`KHR_materials_ior`,KHR_MATERIALS_SHEEN:`KHR_materials_sheen`,KHR_MATERIALS_SPECULAR:`KHR_materials_specular`,KHR_MATERIALS_TRANSMISSION:`KHR_materials_transmission`,KHR_MATERIALS_IRIDESCENCE:`KHR_materials_iridescence`,KHR_MATERIALS_ANISOTROPY:`KHR_materials_anisotropy`,KHR_MATERIALS_UNLIT:`KHR_materials_unlit`,KHR_MATERIALS_VOLUME:`KHR_materials_volume`,KHR_TEXTURE_BASISU:`KHR_texture_basisu`,KHR_TEXTURE_TRANSFORM:`KHR_texture_transform`,KHR_MESH_QUANTIZATION:`KHR_mesh_quantization`,KHR_MATERIALS_EMISSIVE_STRENGTH:`KHR_materials_emissive_strength`,EXT_MATERIALS_BUMP:`EXT_materials_bump`,EXT_TEXTURE_WEBP:`EXT_texture_webp`,EXT_TEXTURE_AVIF:`EXT_texture_avif`,EXT_MESHOPT_COMPRESSION:`EXT_meshopt_compression`,KHR_MESHOPT_COMPRESSION:`KHR_meshopt_compression`,EXT_MESH_GPU_INSTANCING:`EXT_mesh_gpu_instancing`},Qu=class{constructor(e){this.parser=e,this.name=$.KHR_LIGHTS_PUNCTUAL,this.cache={refs:{},uses:{}}}_markDefs(){let e=this.parser,t=this.parser.json.nodes||[];for(let n=0,r=t.length;n<r;n++){let r=t[n];r.extensions&&r.extensions[this.name]&&r.extensions[this.name].light!==void 0&&e._addNodeRef(this.cache,r.extensions[this.name].light)}}_loadLight(e){let t=this.parser,n=`light:`+e,r=t.cache.get(n);if(r)return r;let i=t.json,a=((i.extensions&&i.extensions[this.name]||{}).lights||[])[e],o,s=new J(16777215);a.color!==void 0&&s.setRGB(a.color[0],a.color[1],a.color[2],Je);let c=a.range===void 0?0:a.range;switch(a.type){case`directional`:o=new Qo(s),o.target.position.set(0,0,-1),o.add(o.target);break;case`point`:o=new Yo(s),o.distance=c;break;case`spot`:o=new qo(s),o.distance=c,a.spot=a.spot||{},a.spot.innerConeAngle=a.spot.innerConeAngle===void 0?0:a.spot.innerConeAngle,a.spot.outerConeAngle=a.spot.outerConeAngle===void 0?Math.PI/4:a.spot.outerConeAngle,o.angle=a.spot.outerConeAngle,o.penumbra=1-a.spot.innerConeAngle/a.spot.outerConeAngle,o.target.position.set(0,0,-1),o.add(o.target);break;default:throw Error(`THREE.GLTFLoader: Unexpected light type: `+a.type)}return o.position.set(0,0,0),Ld(o,a),a.intensity!==void 0&&(o.intensity=a.intensity),o.name=t.createUniqueName(a.name||`light_`+e),r=Promise.resolve(o),t.cache.add(n,r),r}getDependency(e,t){if(e===`light`)return this._loadLight(t)}createNodeAttachment(e){let t=this,n=this.parser,r=n.json.nodes[e],i=(r.extensions&&r.extensions[this.name]||{}).light;return i===void 0?null:this._loadLight(i).then(function(e){return n._getNodeRef(t.cache,i,e)})}},$u=class{constructor(){this.name=$.KHR_MATERIALS_UNLIT}getMaterialType(){return di}extendParams(e,t,n){let r=[];e.color=new J(1,1,1),e.opacity=1;let i=t.pbrMetallicRoughness;if(i){if(Array.isArray(i.baseColorFactor)){let t=i.baseColorFactor;e.color.setRGB(t[0],t[1],t[2],Je),e.opacity=t[3]}i.baseColorTexture!==void 0&&r.push(n.assignTexture(e,`map`,i.baseColorTexture,qe))}return Promise.all(r)}},ed=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_EMISSIVE_STRENGTH}extendMaterialParams(e,t){let n=Zu(this.parser,e,this.name);return n===null||n.emissiveStrength!==void 0&&(t.emissiveIntensity=n.emissiveStrength),Promise.resolve()}},td=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_CLEARCOAT}getMaterialType(e){return Zu(this.parser,e,this.name)===null?null:Za}extendMaterialParams(e,t){let n=Zu(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];if(n.clearcoatFactor!==void 0&&(t.clearcoat=n.clearcoatFactor),n.clearcoatTexture!==void 0&&r.push(this.parser.assignTexture(t,`clearcoatMap`,n.clearcoatTexture)),n.clearcoatRoughnessFactor!==void 0&&(t.clearcoatRoughness=n.clearcoatRoughnessFactor),n.clearcoatRoughnessTexture!==void 0&&r.push(this.parser.assignTexture(t,`clearcoatRoughnessMap`,n.clearcoatRoughnessTexture)),n.clearcoatNormalTexture!==void 0&&(r.push(this.parser.assignTexture(t,`clearcoatNormalMap`,n.clearcoatNormalTexture)),n.clearcoatNormalTexture.scale!==void 0)){let e=n.clearcoatNormalTexture.scale;t.clearcoatNormalScale=new U(e,e)}return Promise.all(r)}},nd=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_DISPERSION}getMaterialType(e){return Zu(this.parser,e,this.name)===null?null:Za}extendMaterialParams(e,t){let n=Zu(this.parser,e,this.name);return n===null||(t.dispersion=n.dispersion===void 0?0:n.dispersion),Promise.resolve()}},rd=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_IRIDESCENCE}getMaterialType(e){return Zu(this.parser,e,this.name)===null?null:Za}extendMaterialParams(e,t){let n=Zu(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];return n.iridescenceFactor!==void 0&&(t.iridescence=n.iridescenceFactor),n.iridescenceTexture!==void 0&&r.push(this.parser.assignTexture(t,`iridescenceMap`,n.iridescenceTexture)),n.iridescenceIor!==void 0&&(t.iridescenceIOR=n.iridescenceIor),t.iridescenceThicknessRange===void 0&&(t.iridescenceThicknessRange=[100,400]),n.iridescenceThicknessMinimum!==void 0&&(t.iridescenceThicknessRange[0]=n.iridescenceThicknessMinimum),n.iridescenceThicknessMaximum!==void 0&&(t.iridescenceThicknessRange[1]=n.iridescenceThicknessMaximum),n.iridescenceThicknessTexture!==void 0&&r.push(this.parser.assignTexture(t,`iridescenceThicknessMap`,n.iridescenceThicknessTexture)),Promise.all(r)}},id=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_SHEEN}getMaterialType(e){return Zu(this.parser,e,this.name)===null?null:Za}extendMaterialParams(e,t){let n=Zu(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];if(t.sheenColor=new J(0,0,0),t.sheenRoughness=0,t.sheen=1,n.sheenColorFactor!==void 0){let e=n.sheenColorFactor;t.sheenColor.setRGB(e[0],e[1],e[2],Je)}return n.sheenRoughnessFactor!==void 0&&(t.sheenRoughness=n.sheenRoughnessFactor),n.sheenColorTexture!==void 0&&r.push(this.parser.assignTexture(t,`sheenColorMap`,n.sheenColorTexture,qe)),n.sheenRoughnessTexture!==void 0&&r.push(this.parser.assignTexture(t,`sheenRoughnessMap`,n.sheenRoughnessTexture)),Promise.all(r)}},ad=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_TRANSMISSION}getMaterialType(e){return Zu(this.parser,e,this.name)===null?null:Za}extendMaterialParams(e,t){let n=Zu(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];return n.transmissionFactor!==void 0&&(t.transmission=n.transmissionFactor),n.transmissionTexture!==void 0&&r.push(this.parser.assignTexture(t,`transmissionMap`,n.transmissionTexture)),Promise.all(r)}},od=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_VOLUME}getMaterialType(e){return Zu(this.parser,e,this.name)===null?null:Za}extendMaterialParams(e,t){let n=Zu(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];t.thickness=n.thicknessFactor===void 0?0:n.thicknessFactor,n.thicknessTexture!==void 0&&r.push(this.parser.assignTexture(t,`thicknessMap`,n.thicknessTexture)),t.attenuationDistance=n.attenuationDistance||1/0;let i=n.attenuationColor||[1,1,1];return t.attenuationColor=new J().setRGB(i[0],i[1],i[2],Je),Promise.all(r)}},sd=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_IOR}getMaterialType(e){return Zu(this.parser,e,this.name)===null?null:Za}extendMaterialParams(e,t){let n=Zu(this.parser,e,this.name);return n===null?Promise.resolve():(t.ior=n.ior===void 0?1.5:n.ior,t.ior===0&&(t.ior=1e3),Promise.resolve())}},cd=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_SPECULAR}getMaterialType(e){return Zu(this.parser,e,this.name)===null?null:Za}extendMaterialParams(e,t){let n=Zu(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];t.specularIntensity=n.specularFactor===void 0?1:n.specularFactor,n.specularTexture!==void 0&&r.push(this.parser.assignTexture(t,`specularIntensityMap`,n.specularTexture));let i=n.specularColorFactor||[1,1,1];return t.specularColor=new J().setRGB(i[0],i[1],i[2],Je),n.specularColorTexture!==void 0&&r.push(this.parser.assignTexture(t,`specularColorMap`,n.specularColorTexture,qe)),Promise.all(r)}},ld=class{constructor(e){this.parser=e,this.name=$.EXT_MATERIALS_BUMP}getMaterialType(e){return Zu(this.parser,e,this.name)===null?null:Za}extendMaterialParams(e,t){let n=Zu(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];return t.bumpScale=n.bumpFactor===void 0?1:n.bumpFactor,n.bumpTexture!==void 0&&r.push(this.parser.assignTexture(t,`bumpMap`,n.bumpTexture)),Promise.all(r)}},ud=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_ANISOTROPY}getMaterialType(e){return Zu(this.parser,e,this.name)===null?null:Za}extendMaterialParams(e,t){let n=Zu(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];return n.anisotropyStrength!==void 0&&(t.anisotropy=n.anisotropyStrength),n.anisotropyRotation!==void 0&&(t.anisotropyRotation=n.anisotropyRotation),n.anisotropyTexture!==void 0&&r.push(this.parser.assignTexture(t,`anisotropyMap`,n.anisotropyTexture)),Promise.all(r)}},dd=class{constructor(e){this.parser=e,this.name=$.KHR_TEXTURE_BASISU}loadTexture(e){let t=this.parser,n=t.json,r=n.textures[e];if(!r.extensions||!r.extensions[this.name])return null;let i=r.extensions[this.name],a=t.options.ktx2Loader;if(!a){if(n.extensionsRequired&&n.extensionsRequired.indexOf(this.name)>=0)throw Error(`THREE.GLTFLoader: setKTX2Loader must be called before loading KTX2 textures`);return null}return t.loadTextureImage(e,i.source,a)}},fd=class{constructor(e){this.parser=e,this.name=$.EXT_TEXTURE_WEBP}loadTexture(e){let t=this.name,n=this.parser,r=n.json,i=r.textures[e];if(!i.extensions||!i.extensions[t])return null;let a=i.extensions[t],o=r.images[a.source],s=n.textureLoader;if(o.uri){let e=n.options.manager.getHandler(o.uri);e!==null&&(s=e)}return n.loadTextureImage(e,a.source,s)}},pd=class{constructor(e){this.parser=e,this.name=$.EXT_TEXTURE_AVIF}loadTexture(e){let t=this.name,n=this.parser,r=n.json,i=r.textures[e];if(!i.extensions||!i.extensions[t])return null;let a=i.extensions[t],o=r.images[a.source],s=n.textureLoader;if(o.uri){let e=n.options.manager.getHandler(o.uri);e!==null&&(s=e)}return n.loadTextureImage(e,a.source,s)}},md=class{constructor(e,t){this.name=t,this.parser=e}loadBufferView(e){let t=this.parser.json,n=t.bufferViews[e];if(n.extensions&&n.extensions[this.name]){let e=n.extensions[this.name],r=this.parser.getDependency(`buffer`,e.buffer),i=this.parser.options.meshoptDecoder;if(!i||!i.supported){if(t.extensionsRequired&&t.extensionsRequired.indexOf(this.name)>=0)throw Error(`THREE.GLTFLoader: setMeshoptDecoder must be called before loading compressed files`);return null}return r.then(function(t){let n=e.byteOffset||0,r=e.byteLength||0,a=e.count,o=e.byteStride,s=new Uint8Array(t,n,r);return i.decodeGltfBufferAsync?i.decodeGltfBufferAsync(a,o,s,e.mode,e.filter).then(function(e){return e.buffer}):i.ready.then(function(){let t=new ArrayBuffer(a*o);return i.decodeGltfBuffer(new Uint8Array(t),a,o,s,e.mode,e.filter),t})})}else return null}},hd=class{constructor(e){this.name=$.EXT_MESH_GPU_INSTANCING,this.parser=e}createNodeMesh(e){let t=this.parser.json,n=t.nodes[e];if(!n.extensions||!n.extensions[this.name]||n.mesh===void 0)return null;let r=t.meshes[n.mesh];for(let e of r.primitives)if(e.mode!==Ed.TRIANGLES&&e.mode!==Ed.TRIANGLE_STRIP&&e.mode!==Ed.TRIANGLE_FAN&&e.mode!==void 0)return null;let i=n.extensions[this.name].attributes,a=[],o={};for(let e in i)a.push(this.parser.getDependency(`accessor`,i[e]).then(t=>(o[e]=t,o[e])));return a.length<1?null:(a.push(this.parser.createNodeMesh(e)),Promise.all(a).then(e=>{let t=e.pop(),n=t.isGroup?t.children:[t],r=e[0].count,i=[];for(let e of n){let t=new q,n=new W,a=new Lt,s=new W(1,1,1),c=new Ji(e.geometry,e.material,r);for(let e=0;e<r;e++)o.TRANSLATION&&n.fromBufferAttribute(o.TRANSLATION,e),o.ROTATION&&a.fromBufferAttribute(o.ROTATION,e),o.SCALE&&s.fromBufferAttribute(o.SCALE,e),c.setMatrixAt(e,t.compose(n,a,s));for(let t in o)if(t===`_COLOR_0`){let e=o[t];c.instanceColor=new Bi(e.array,e.itemSize,e.normalized)}else t!==`TRANSLATION`&&t!==`ROTATION`&&t!==`SCALE`&&e.geometry.setAttribute(t,o[t]);Mn.prototype.copy.call(c,e),this.parser.assignFinalMaterial(c),i.push(c)}return t.isGroup?(t.clear(),t.add(...i),t):i[0]}))}},gd=`glTF`,_d=12,vd={JSON:1313821514,BIN:5130562},yd=class{constructor(e){this.name=$.KHR_BINARY_GLTF,this.content=null,this.body=null;let t=new DataView(e,0,_d),n=new TextDecoder;if(this.header={magic:n.decode(new Uint8Array(e.slice(0,4))),version:t.getUint32(4,!0),length:t.getUint32(8,!0)},this.header.magic!==gd)throw Error(`THREE.GLTFLoader: Unsupported glTF-Binary header.`);if(this.header.version<2)throw Error(`THREE.GLTFLoader: Legacy binary file detected.`);let r=this.header.length-_d,i=new DataView(e,_d),a=0;for(;a<r;){let t=i.getUint32(a,!0);a+=4;let r=i.getUint32(a,!0);if(a+=4,r===vd.JSON){let r=new Uint8Array(e,_d+a,t);this.content=n.decode(r)}else if(r===vd.BIN){let n=_d+a;this.body=e.slice(n,n+t)}a+=t}if(this.content===null)throw Error(`THREE.GLTFLoader: JSON content not found.`)}},bd=class{constructor(e,t){if(!t)throw Error(`THREE.GLTFLoader: No DRACOLoader instance provided.`);this.name=$.KHR_DRACO_MESH_COMPRESSION,this.json=e,this.dracoLoader=t,this.dracoLoader.preload()}decodePrimitive(e,t){let n=this.json,r=this.dracoLoader,i=e.extensions[this.name].bufferView,a=e.extensions[this.name].attributes,o={},s={},c={};for(let e in a){let t=jd[e]||e.toLowerCase();o[t]=a[e]}for(let t in e.attributes){let r=jd[t]||t.toLowerCase();if(a[t]!==void 0){let i=n.accessors[e.attributes[t]];c[r]=Dd[i.componentType].name,s[r]=i.normalized===!0}}return t.getDependency(`bufferView`,i).then(function(e){return new Promise(function(t,n){r.decodeDracoFile(e,function(e){for(let t in e.attributes){let n=e.attributes[t],r=s[t];r!==void 0&&(n.normalized=r)}t(e)},o,c,Je,n)})})}},xd=class{constructor(){this.name=$.KHR_TEXTURE_TRANSFORM}extendTexture(e,t){return(t.texCoord===void 0||t.texCoord===e.channel)&&t.offset===void 0&&t.rotation===void 0&&t.scale===void 0?e:(e=e.clone(),t.texCoord!==void 0&&(e.channel=t.texCoord),t.offset!==void 0&&e.offset.fromArray(t.offset),t.rotation!==void 0&&(e.rotation=t.rotation),t.scale!==void 0&&e.repeat.fromArray(t.scale),e.needsUpdate=!0,e)}},Sd=class{constructor(){this.name=$.KHR_MESH_QUANTIZATION}},Cd=class extends ao{constructor(e,t,n,r){super(e,t,n,r)}copySampleValue_(e){let t=this.resultBuffer,n=this.sampleValues,r=this.valueSize,i=e*r*3+r;for(let e=0;e!==r;e++)t[e]=n[i+e];return t}interpolate_(e,t,n,r){let i=this.resultBuffer,a=this.sampleValues,o=this.valueSize,s=o*2,c=o*3,l=r-t,u=(n-t)/l,d=u*u,f=d*u,p=e*c,m=p-c,h=-2*f+3*d,g=f-d,_=1-h,v=g-d+u;for(let e=0;e!==o;e++){let t=a[m+e+o],n=a[m+e+s]*l,r=a[p+e+o],c=a[p+e]*l;i[e]=_*t+v*n+h*r+g*c}return i}},wd=new Lt,Td=class extends Cd{interpolate_(e,t,n,r){let i=super.interpolate_(e,t,n,r);return wd.fromArray(i).normalize().toArray(i),i}},Ed={FLOAT:5126,FLOAT_MAT3:35675,FLOAT_MAT4:35676,FLOAT_VEC2:35664,FLOAT_VEC3:35665,FLOAT_VEC4:35666,LINEAR:9729,REPEAT:10497,SAMPLER_2D:35678,POINTS:0,LINES:1,LINE_LOOP:2,LINE_STRIP:3,TRIANGLES:4,TRIANGLE_STRIP:5,TRIANGLE_FAN:6,UNSIGNED_BYTE:5121,UNSIGNED_SHORT:5123},Dd={5120:Int8Array,5121:Uint8Array,5122:Int16Array,5123:Uint16Array,5125:Uint32Array,5126:Float32Array},Od={9728:f,9729:h,9984:p,9985:g,9986:m,9987:_},kd={33071:u,33648:d,10497:l},Ad={SCALAR:1,VEC2:2,VEC3:3,VEC4:4,MAT2:4,MAT3:9,MAT4:16},jd={POSITION:`position`,NORMAL:`normal`,TANGENT:`tangent`,TEXCOORD_0:`uv`,TEXCOORD_1:`uv1`,TEXCOORD_2:`uv2`,TEXCOORD_3:`uv3`,COLOR_0:`color`,WEIGHTS_0:`skinWeight`,JOINTS_0:`skinIndex`},Md={scale:`scale`,translation:`position`,rotation:`quaternion`,weights:`morphTargetInfluences`},Nd={CUBICSPLINE:void 0,LINEAR:ze,STEP:Re},Pd={OPAQUE:`OPAQUE`,MASK:`MASK`,BLEND:`BLEND`};function Fd(e){return e.DefaultMaterial===void 0&&(e.DefaultMaterial=new Xa({color:16777215,emissive:0,metalness:1,roughness:1,transparent:!1,depthTest:!0,side:0})),e.DefaultMaterial}function Id(e,t,n){for(let r in n.extensions)e[r]===void 0&&(t.userData.gltfExtensions=t.userData.gltfExtensions||{},t.userData.gltfExtensions[r]=n.extensions[r])}function Ld(e,t){t.extras!==void 0&&(typeof t.extras==`object`?Object.assign(e.userData,t.extras):console.warn(`THREE.GLTFLoader: Ignoring primitive type .extras, `+t.extras))}function Rd(e,t,n){let r=!1,i=!1,a=!1;for(let e=0,n=t.length;e<n;e++){let n=t[e];if(n.POSITION!==void 0&&(r=!0),n.NORMAL!==void 0&&(i=!0),n.COLOR_0!==void 0&&(a=!0),r&&i&&a)break}if(!r&&!i&&!a)return Promise.resolve(e);let o=[],s=[],c=[];for(let l=0,u=t.length;l<u;l++){let u=t[l];if(r){let t=u.POSITION===void 0?e.attributes.position:n.getDependency(`accessor`,u.POSITION);o.push(t)}if(i){let t=u.NORMAL===void 0?e.attributes.normal:n.getDependency(`accessor`,u.NORMAL);s.push(t)}if(a){let t=u.COLOR_0===void 0?e.attributes.color:n.getDependency(`accessor`,u.COLOR_0);c.push(t)}}return Promise.all([Promise.all(o),Promise.all(s),Promise.all(c)]).then(function(t){let n=t[0],o=t[1],s=t[2];return r&&(e.morphAttributes.position=n),i&&(e.morphAttributes.normal=o),a&&(e.morphAttributes.color=s),e.morphTargetsRelative=!0,e})}function zd(e,t){if(e.updateMorphTargets(),t.weights!==void 0)for(let n=0,r=t.weights.length;n<r;n++)e.morphTargetInfluences[n]=t.weights[n];if(t.extras&&Array.isArray(t.extras.targetNames)){let n=t.extras.targetNames;if(e.morphTargetInfluences.length===n.length){e.morphTargetDictionary={};for(let t=0,r=n.length;t<r;t++)e.morphTargetDictionary[n[t]]=t}else console.warn(`THREE.GLTFLoader: Invalid extras.targetNames length. Ignoring names.`)}}function Bd(e){let t,n=e.extensions&&e.extensions[$.KHR_DRACO_MESH_COMPRESSION];if(t=n?`draco:`+n.bufferView+`:`+n.indices+`:`+Vd(n.attributes):e.indices+`:`+Vd(e.attributes)+`:`+e.mode,e.targets!==void 0)for(let n=0,r=e.targets.length;n<r;n++)t+=`:`+Vd(e.targets[n]);return t}function Vd(e){let t=``,n=Object.keys(e).sort();for(let r=0,i=n.length;r<i;r++)t+=n[r]+`:`+e[n[r]]+`;`;return t}function Hd(e){switch(e){case Int8Array:return 1/127;case Uint8Array:return 1/255;case Int16Array:return 1/32767;case Uint16Array:return 1/65535;default:throw Error(`THREE.GLTFLoader: Unsupported normalized accessor component type.`)}}function Ud(e){return e.search(/\.jpe?g($|\?)/i)>0||e.search(/^data\:image\/jpeg/)===0?`image/jpeg`:e.search(/\.webp($|\?)/i)>0||e.search(/^data\:image\/webp/)===0?`image/webp`:e.search(/\.ktx2($|\?)/i)>0||e.search(/^data\:image\/ktx2/)===0?`image/ktx2`:`image/png`}var Wd=new q,Gd=class{constructor(e={},t={}){this.json=e,this.extensions={},this.plugins={},this.options=t,this.cache=new Xu,this.associations=new Map,this.primitiveCache={},this.nodeCache={},this.meshCache={refs:{},uses:{}},this.cameraCache={refs:{},uses:{}},this.lightCache={refs:{},uses:{}},this.sourceCache={},this.textureCache={},this.nodeNamesUsed={};let n=!1,r=-1,i=!1,a=-1;if(typeof navigator<`u`&&navigator.userAgent!==void 0){let e=navigator.userAgent;n=/^((?!chrome|android).)*safari/i.test(e)===!0;let t=e.match(/Version\/(\d+)/);r=n&&t?parseInt(t[1],10):-1,i=e.indexOf(`Firefox`)>-1,a=i?e.match(/Firefox\/([0-9]+)\./)[1]:-1}typeof createImageBitmap>`u`||n&&r<17||i&&a<98?this.textureLoader=new jo(this.options.manager):this.textureLoader=new ts(this.options.manager),this.textureLoader.setCrossOrigin(this.options.crossOrigin),this.textureLoader.setRequestHeader(this.options.requestHeader),this.fileLoader=new Oo(this.options.manager),this.fileLoader.setResponseType(`arraybuffer`),this.options.crossOrigin===`use-credentials`&&this.fileLoader.setWithCredentials(!0)}setExtensions(e){this.extensions=e}setPlugins(e){this.plugins=e}parse(e,t){let n=this,r=this.json,i=this.extensions;this.cache.removeAll(),this.nodeCache={},this._invokeAll(function(e){return e._markDefs&&e._markDefs()}),Promise.all(this._invokeAll(function(e){return e.beforeRoot&&e.beforeRoot()})).then(function(){return Promise.all([n.getDependencies(`scene`),n.getDependencies(`animation`),n.getDependencies(`camera`)])}).then(function(t){let a={scene:t[0][r.scene||0],scenes:t[0],animations:t[1],cameras:t[2],asset:r.asset,parser:n,userData:{}};return Id(i,a,r),Ld(a,r),Promise.all(n._invokeAll(function(e){return e.afterRoot&&e.afterRoot(a)})).then(function(){for(let e of a.scenes)e.updateMatrixWorld();e(a)})}).catch(t)}_markDefs(){let e=this.json.nodes||[],t=this.json.skins||[],n=this.json.meshes||[];for(let n=0,r=t.length;n<r;n++){let r=t[n].joints;for(let t=0,n=r.length;t<n;t++)e[r[t]].isBone=!0}for(let t=0,r=e.length;t<r;t++){let r=e[t];r.mesh!==void 0&&(this._addNodeRef(this.meshCache,r.mesh),r.skin!==void 0&&(n[r.mesh].isSkinnedMesh=!0)),r.camera!==void 0&&this._addNodeRef(this.cameraCache,r.camera)}}_addNodeRef(e,t){t!==void 0&&(e.refs[t]===void 0&&(e.refs[t]=e.uses[t]=0),e.refs[t]++)}_getNodeRef(e,t,n){if(e.refs[t]<=1)return n;let r=n.clone(),i=(e,t)=>{let n=this.associations.get(e);n!=null&&this.associations.set(t,n);for(let[n,r]of e.children.entries())i(r,t.children[n])};return i(n,r),r.name+=`_instance_`+ e.uses[t]++,r}_invokeOne(e){let t=Object.values(this.plugins);t.push(this);for(let n=0;n<t.length;n++){let r=e(t[n]);if(r)return r}return null}_invokeAll(e){let t=Object.values(this.plugins);t.unshift(this);let n=[];for(let r=0;r<t.length;r++){let i=e(t[r]);i&&n.push(i)}return n}getDependency(e,t){let n=e+`:`+t,r=this.cache.get(n);if(!r){switch(e){case`scene`:r=this.loadScene(t);break;case`node`:r=this._invokeOne(function(e){return e.loadNode&&e.loadNode(t)});break;case`mesh`:r=this._invokeOne(function(e){return e.loadMesh&&e.loadMesh(t)});break;case`accessor`:r=this.loadAccessor(t);break;case`bufferView`:r=this._invokeOne(function(e){return e.loadBufferView&&e.loadBufferView(t)});break;case`buffer`:r=this.loadBuffer(t);break;case`material`:r=this._invokeOne(function(e){return e.loadMaterial&&e.loadMaterial(t)});break;case`texture`:r=this._invokeOne(function(e){return e.loadTexture&&e.loadTexture(t)});break;case`skin`:r=this.loadSkin(t);break;case`animation`:r=this._invokeOne(function(e){return e.loadAnimation&&e.loadAnimation(t)});break;case`camera`:r=this.loadCamera(t);break;default:if(r=this._invokeOne(function(n){return n!=this&&n.getDependency&&n.getDependency(e,t)}),!r)throw Error(`Unknown type: `+e);break}this.cache.add(n,r)}return r}getDependencies(e){let t=this.cache.get(e);if(!t){let n=this,r=this.json[e+(e===`mesh`?`es`:`s`)]||[];t=Promise.all(r.map(function(t,r){return n.getDependency(e,r)})),this.cache.add(e,t)}return t}loadBuffer(e){let t=this.json.buffers[e],n=this.fileLoader;if(t.type&&t.type!==`arraybuffer`)throw Error(`THREE.GLTFLoader: `+t.type+` buffer type is not supported.`);if(t.uri===void 0&&e===0)return Promise.resolve(this.extensions[$.KHR_BINARY_GLTF].body);let r=this.options;return new Promise(function(e,i){n.load($o.resolveURL(t.uri,r.path),e,void 0,function(){i(Error(`THREE.GLTFLoader: Failed to load buffer "`+t.uri+`".`))})})}loadBufferView(e){let t=this.json.bufferViews[e];return this.getDependency(`buffer`,t.buffer).then(function(e){let n=t.byteLength||0,r=t.byteOffset||0;return e.slice(r,r+n)})}loadAccessor(e){let t=this,n=this.json,r=this.json.accessors[e];if(r.bufferView===void 0&&r.sparse===void 0){let e=Ad[r.type],t=Dd[r.componentType],n=r.normalized===!0,i=new t(r.count*e);return Promise.resolve(new xr(i,e,n))}let i=[];return r.bufferView===void 0?i.push(null):i.push(this.getDependency(`bufferView`,r.bufferView)),r.sparse!==void 0&&(i.push(this.getDependency(`bufferView`,r.sparse.indices.bufferView)),i.push(this.getDependency(`bufferView`,r.sparse.values.bufferView))),Promise.all(i).then(function(e){let i=e[0],a=Ad[r.type],o=Dd[r.componentType],s=o.BYTES_PER_ELEMENT,c=s*a,l=r.byteOffset||0,u=r.bufferView===void 0?void 0:n.bufferViews[r.bufferView].byteStride,d=r.normalized===!0,f,p;if(u&&u!==c){let e=Math.floor(l/u),n=`InterleavedBuffer:`+r.bufferView+`:`+r.componentType+`:`+e+`:`+r.count,c=t.cache.get(n);c||(f=new o(i,e*u,r.count*u/s),c=new Ir(f,u/s),t.cache.add(n,c)),p=new Rr(c,a,l%u/s,d)}else f=i===null?new o(r.count*a):new o(i,l,r.count*a),p=new xr(f,a,d);if(r.sparse!==void 0){let t=Ad.SCALAR,n=Dd[r.sparse.indices.componentType],s=r.sparse.indices.byteOffset||0,c=r.sparse.values.byteOffset||0,l=new n(e[1],s,r.sparse.count*t),u=new o(e[2],c,r.sparse.count*a);i!==null&&(p=new xr(p.array.slice(),p.itemSize,p.normalized)),p.normalized=!1;for(let e=0,t=l.length;e<t;e++){let t=l[e];if(p.setX(t,u[e*a]),a>=2&&p.setY(t,u[e*a+1]),a>=3&&p.setZ(t,u[e*a+2]),a>=4&&p.setW(t,u[e*a+3]),a>=5)throw Error(`THREE.GLTFLoader: Unsupported itemSize in sparse BufferAttribute.`)}p.normalized=d}return p})}loadTexture(e){let t=this.json,n=this.options,r=t.textures[e].source,i=t.images[r],a=this.textureLoader;if(i.uri){let e=n.manager.getHandler(i.uri);e!==null&&(a=e)}return this.loadTextureImage(e,r,a)}loadTextureImage(e,t,n){let r=this,i=this.json,a=i.textures[e],o=i.images[t],s=(o.uri||o.bufferView)+`:`+a.sampler;if(this.textureCache[s])return this.textureCache[s];let c=this.loadImageSource(t,n).then(function(t){t.flipY=!1,t.name=a.name||o.name||``,t.name===``&&typeof o.uri==`string`&&o.uri.startsWith(`data:image/`)===!1&&(t.name=o.uri);let n=(i.samplers||{})[a.sampler]||{};return t.magFilter=Od[n.magFilter]||1006,t.minFilter=Od[n.minFilter]||1008,t.wrapS=kd[n.wrapS]||1e3,t.wrapT=kd[n.wrapT]||1e3,t.generateMipmaps=!t.isCompressedTexture&&t.minFilter!==1003&&t.minFilter!==1006,r.associations.set(t,{textures:e}),t}).catch(function(){return null});return this.textureCache[s]=c,c}loadImageSource(e,t){let n=this,r=this.json,i=this.options;if(this.sourceCache[e]!==void 0)return this.sourceCache[e].then(e=>e.clone());let a=r.images[e],o=self.URL||self.webkitURL,s=a.uri||``,c=!1;if(a.bufferView!==void 0)s=n.getDependency(`bufferView`,a.bufferView).then(function(e){c=!0;let t=new Blob([e],{type:a.mimeType});return s=o.createObjectURL(t),s});else if(a.uri===void 0)throw Error(`THREE.GLTFLoader: Image `+e+` is missing URI and bufferView`);let l=Promise.resolve(s).then(function(e){return new Promise(function(n,r){let a=n;t.isImageBitmapLoader===!0&&(a=function(e){let t=new $t(e);t.needsUpdate=!0,n(t)}),t.load($o.resolveURL(e,i.path),a,void 0,r)})}).then(function(e){return c===!0&&o.revokeObjectURL(s),Ld(e,a),e.userData.mimeType=a.mimeType||Ud(a.uri),e}).catch(function(e){throw console.error(`THREE.GLTFLoader: Couldn't load texture`,s),e});return this.sourceCache[e]=l,l}assignTexture(e,t,n,r){let i=this;return this.getDependency(`texture`,n.index).then(function(a){if(!a)return null;if(n.texCoord!==void 0&&n.texCoord>0&&(a=a.clone(),a.channel=n.texCoord),i.extensions[$.KHR_TEXTURE_TRANSFORM]){let e=n.extensions===void 0?void 0:n.extensions[$.KHR_TEXTURE_TRANSFORM];if(e){let t=i.associations.get(a);a=i.extensions[$.KHR_TEXTURE_TRANSFORM].extendTexture(a,e),i.associations.set(a,t)}}return r!==void 0&&(a.colorSpace=r),e[t]=a,a})}assignFinalMaterial(e){let t=e.geometry,n=e.material,r=t.attributes.tangent===void 0,i=t.attributes.color!==void 0,a=t.attributes.normal===void 0;if(e.isPoints){let e=`PointsMaterial:`+n.uuid,t=this.cache.get(e);t||(t=new _a,Br.prototype.copy.call(t,n),t.color.copy(n.color),t.map=n.map,t.sizeAttenuation=!1,this.cache.add(e,t)),n=t}else if(e.isLine){let e=`LineBasicMaterial:`+n.uuid,t=this.cache.get(e);t||(t=new ra,Br.prototype.copy.call(t,n),t.color.copy(n.color),t.map=n.map,this.cache.add(e,t)),n=t}if(r||i||a){let e=`ClonedMaterial:`+n.uuid+`:`;r&&(e+=`derivative-tangents:`),i&&(e+=`vertex-colors:`),a&&(e+=`flat-shading:`);let t=this.cache.get(e);t||(t=n.clone(),i&&(t.vertexColors=!0),a&&(t.flatShading=!0),r&&(t.normalScale&&(t.normalScale.y*=-1),t.clearcoatNormalScale&&(t.clearcoatNormalScale.y*=-1)),this.cache.add(e,t),this.associations.set(t,this.associations.get(n))),n=t}e.material=n}getMaterialType(){return Xa}loadMaterial(e){let t=this,n=this.json,r=this.extensions,i=n.materials[e],a,o={},s=i.extensions||{},c=[];if(s[$.KHR_MATERIALS_UNLIT]){let e=r[$.KHR_MATERIALS_UNLIT];a=e.getMaterialType(),c.push(e.extendParams(o,i,t))}else{let n=i.pbrMetallicRoughness||{};if(o.color=new J(1,1,1),o.opacity=1,Array.isArray(n.baseColorFactor)){let e=n.baseColorFactor;o.color.setRGB(e[0],e[1],e[2],Je),o.opacity=e[3]}n.baseColorTexture!==void 0&&c.push(t.assignTexture(o,`map`,n.baseColorTexture,qe)),o.metalness=n.metallicFactor===void 0?1:n.metallicFactor,o.roughness=n.roughnessFactor===void 0?1:n.roughnessFactor,n.metallicRoughnessTexture!==void 0&&(c.push(t.assignTexture(o,`metalnessMap`,n.metallicRoughnessTexture)),c.push(t.assignTexture(o,`roughnessMap`,n.metallicRoughnessTexture))),a=this._invokeOne(function(t){return t.getMaterialType&&t.getMaterialType(e)}),c.push(Promise.all(this._invokeAll(function(t){return t.extendMaterialParams&&t.extendMaterialParams(e,o)})))}i.doubleSided===!0&&(o.side=2);let l=i.alphaMode||Pd.OPAQUE;if(l===Pd.BLEND?(o.transparent=!0,o.depthWrite=!1):(o.transparent=!1,l===Pd.MASK&&(o.alphaTest=i.alphaCutoff===void 0?.5:i.alphaCutoff)),i.normalTexture!==void 0&&a!==di&&(c.push(t.assignTexture(o,`normalMap`,i.normalTexture)),o.normalScale=new U(1,1),i.normalTexture.scale!==void 0)){let e=i.normalTexture.scale;o.normalScale.set(e,e)}if(i.occlusionTexture!==void 0&&a!==di&&(c.push(t.assignTexture(o,`aoMap`,i.occlusionTexture)),i.occlusionTexture.strength!==void 0&&(o.aoMapIntensity=i.occlusionTexture.strength)),i.emissiveFactor!==void 0&&a!==di){let e=i.emissiveFactor;o.emissive=new J().setRGB(e[0],e[1],e[2],Je)}return i.emissiveTexture!==void 0&&a!==di&&c.push(t.assignTexture(o,`emissiveMap`,i.emissiveTexture,qe)),Promise.all(c).then(function(){let n=new a(o);return i.name&&(n.name=i.name),Ld(n,i),t.associations.set(n,{materials:e}),i.extensions&&Id(r,n,i),n})}createUniqueName(e){let t=_s.sanitizeNodeName(e||``);return t in this.nodeNamesUsed?t+`_`+ ++this.nodeNamesUsed[t]:(this.nodeNamesUsed[t]=0,t)}loadGeometries(e){let t=this,n=this.extensions,r=this.primitiveCache;function i(e){return n[$.KHR_DRACO_MESH_COMPRESSION].decodePrimitive(e,t).then(function(n){return qd(n,e,t)})}let a=[];for(let n=0,o=e.length;n<o;n++){let o=e[n],s=Bd(o),c=r[s];if(c)a.push(c.promise);else{let e;e=o.extensions&&o.extensions[$.KHR_DRACO_MESH_COMPRESSION]?i(o):qd(new Fr,o,t),r[s]={primitive:o,promise:e},a.push(e)}}return Promise.all(a)}loadMesh(e){let t=this,n=this.json,r=this.extensions,i=n.meshes[e],a=i.primitives,o=[];for(let e=0,t=a.length;e<t;e++){let t=a[e].material===void 0?Fd(this.cache):this.getDependency(`material`,a[e].material);o.push(t)}return o.push(t.loadGeometries(a)),Promise.all(o).then(function(n){let o=n.slice(0,n.length-1),s=n[n.length-1],c=[];for(let n=0,l=s.length;n<l;n++){let l=s[n],u=a[n],d,f=o[n];if(u.mode===Ed.TRIANGLES||u.mode===Ed.TRIANGLE_STRIP||u.mode===Ed.TRIANGLE_FAN||u.mode===void 0)d=i.isSkinnedMesh===!0?new Pi(l,f):new X(l,f),d.isSkinnedMesh===!0&&d.normalizeSkinWeights(),u.mode===Ed.TRIANGLE_STRIP?d.geometry=Ku(d.geometry,1):u.mode===Ed.TRIANGLE_FAN&&(d.geometry=Ku(d.geometry,2));else if(u.mode===Ed.LINES)d=new ha(l,f);else if(u.mode===Ed.LINE_STRIP)d=new da(l,f);else if(u.mode===Ed.LINE_LOOP)d=new ga(l,f);else if(u.mode===Ed.POINTS)d=new Sa(l,f);else throw Error(`THREE.GLTFLoader: Primitive mode unsupported: `+u.mode);Object.keys(d.geometry.morphAttributes).length>0&&zd(d,i),d.name=t.createUniqueName(i.name||`mesh_`+e),Ld(d,i),u.extensions&&Id(r,d,u),t.assignFinalMaterial(d),c.push(d)}for(let n=0,r=c.length;n<r;n++)t.associations.set(c[n],{meshes:e,primitives:n});if(c.length===1)return i.extensions&&Id(r,c[0],i),c[0];let l=new Nn;i.extensions&&Id(r,l,i),t.associations.set(l,{meshes:e});for(let e=0,t=c.length;e<t;e++)l.add(c[e]);return l})}loadCamera(e){let t,n=this.json.cameras[e],r=n[n.type];if(!r){console.warn(`THREE.GLTFLoader: Missing camera parameters.`);return}return n.type===`perspective`?t=new Go(It.radToDeg(r.yfov),r.aspectRatio||1,r.znear||1,r.zfar||2e6):n.type===`orthographic`&&(t=new Xo(-r.xmag,r.xmag,r.ymag,-r.ymag,r.znear,r.zfar)),n.name&&(t.name=this.createUniqueName(n.name)),Ld(t,n),Promise.resolve(t)}loadSkin(e){let t=this.json.skins[e],n=[];for(let e=0,r=t.joints.length;e<r;e++)n.push(this._loadNodeShallow(t.joints[e]));return t.inverseBindMatrices===void 0?n.push(null):n.push(this.getDependency(`accessor`,t.inverseBindMatrices)),Promise.all(n).then(function(e){let n=e.pop(),r=e,i=[],a=[];for(let e=0,o=r.length;e<o;e++){let o=r[e];if(o){i.push(o);let t=new q;n!==null&&t.fromArray(n.array,e*16),a.push(t)}else console.warn(`THREE.GLTFLoader: Joint "%s" could not be found.`,t.joints[e])}return new zi(i,a)})}loadAnimation(e){let t=this.json,n=this,r=t.animations[e],i=r.name?r.name:`animation_`+e,a=[],o=[],s=[],c=[],l=[];for(let e=0,t=r.channels.length;e<t;e++){let t=r.channels[e],n=r.samplers[t.sampler],i=t.target,u=i.node,d=r.parameters===void 0?n.input:r.parameters[n.input],f=r.parameters===void 0?n.output:r.parameters[n.output];i.node!==void 0&&(a.push(this.getDependency(`node`,u)),o.push(this.getDependency(`accessor`,d)),s.push(this.getDependency(`accessor`,f)),c.push(n),l.push(i))}return Promise.all([Promise.all(a),Promise.all(o),Promise.all(s),Promise.all(c),Promise.all(l)]).then(function(e){let t=e[0],a=e[1],o=e[2],s=e[3],c=e[4],l=[];for(let e=0,r=t.length;e<r;e++){let r=t[e],i=a[e],u=o[e],d=s[e],f=c[e];if(r===void 0)continue;r.updateMatrix&&r.updateMatrix();let p=n._createAnimationTracks(r,i,u,d,f);if(p)for(let e=0;e<p.length;e++)l.push(p[e])}let u=new yo(i,void 0,l);return Ld(u,r),u})}createNodeMesh(e){let t=this.json,n=this,r=t.nodes[e];return r.mesh===void 0?null:n.getDependency(`mesh`,r.mesh).then(function(e){let t=n._getNodeRef(n.meshCache,r.mesh,e);return r.weights!==void 0&&t.traverse(function(e){if(e.isMesh)for(let t=0,n=r.weights.length;t<n;t++)e.morphTargetInfluences[t]=r.weights[t]}),t})}loadNode(e){let t=this.json,n=this,r=t.nodes[e],i=n._loadNodeShallow(e),a=[],o=r.children||[];for(let e=0,t=o.length;e<t;e++)a.push(n.getDependency(`node`,o[e]));let s=r.skin===void 0?Promise.resolve(null):n.getDependency(`skin`,r.skin);return Promise.all([i,Promise.all(a),s]).then(function(e){let t=e[0],n=e[1],r=e[2];r!==null&&t.traverse(function(e){e.isSkinnedMesh&&e.bind(r,Wd)});for(let e=0,r=n.length;e<r;e++)t.add(n[e]);if(t.userData.pivot!==void 0&&n.length>0){let e=t.userData.pivot,r=n[0];t.pivot=new W().fromArray(e),t.position.x-=e[0],t.position.y-=e[1],t.position.z-=e[2],r.position.set(0,0,0),delete t.userData.pivot}return t})}_loadNodeShallow(e){let t=this.json,n=this.extensions,r=this;if(this.nodeCache[e]!==void 0)return this.nodeCache[e];let i=t.nodes[e],a=i.name?r.createUniqueName(i.name):``,o=[],s=r._invokeOne(function(t){return t.createNodeMesh&&t.createNodeMesh(e)});return s&&o.push(s),i.camera!==void 0&&o.push(r.getDependency(`camera`,i.camera).then(function(e){return r._getNodeRef(r.cameraCache,i.camera,e)})),r._invokeAll(function(t){return t.createNodeAttachment&&t.createNodeAttachment(e)}).forEach(function(e){o.push(e)}),this.nodeCache[e]=Promise.all(o).then(function(t){let o;if(o=i.isBone===!0?new Fi:t.length>1?new Nn:t.length===1?t[0]:new Mn,o!==t[0])for(let e=0,n=t.length;e<n;e++)o.add(t[e]);if(i.name&&(o.userData.name=i.name,o.name=a),Ld(o,i),i.extensions&&Id(n,o,i),i.matrix!==void 0){let e=new q;e.fromArray(i.matrix),o.applyMatrix4(e)}else i.translation!==void 0&&o.position.fromArray(i.translation),i.rotation!==void 0&&o.quaternion.fromArray(i.rotation),i.scale!==void 0&&o.scale.fromArray(i.scale);if(!r.associations.has(o))r.associations.set(o,{});else if(i.mesh!==void 0&&r.meshCache.refs[i.mesh]>1){let e=r.associations.get(o);r.associations.set(o,{...e})}return r.associations.get(o).nodes=e,o}),this.nodeCache[e]}loadScene(e){let t=this.extensions,n=this.json.scenes[e],r=this,i=new Nn;n.name&&(i.name=r.createUniqueName(n.name)),Ld(i,n),n.extensions&&Id(t,i,n);let a=n.nodes||[],o=[];for(let e=0,t=a.length;e<t;e++)o.push(r.getDependency(`node`,a[e]));return Promise.all(o).then(function(e){for(let t=0,n=e.length;t<n;t++){let n=e[t];n.parent===null?i.add(n):i.add(qu(n))}return r.associations=(e=>{let t=new Map;for(let[e,n]of r.associations)(e instanceof Br||e instanceof $t)&&t.set(e,n);return e.traverse(e=>{let n=r.associations.get(e);n!=null&&t.set(e,n)}),t})(i),i})}_createAnimationTracks(e,t,n,r,i){let a=[],o=e.name?e.name:e.uuid,s=[];function c(e){e.morphTargetInfluences&&s.push(e.name?e.name:e.uuid)}Md[i.path]===Md.weights?(c(e),e.isGroup&&e.children.forEach(c)):s.push(o);let l;switch(Md[i.path]){case Md.weights:l=mo;break;case Md.rotation:l=go;break;case Md.translation:case Md.scale:l=vo;break;default:switch(n.itemSize){case 1:l=mo;break;default:l=vo;break}break}let u=r.interpolation===void 0?ze:Nd[r.interpolation],d=this._getArrayFromAccessor(n);for(let e=0,n=s.length;e<n;e++){let n=new l(s[e]+`.`+Md[i.path],t.array,d,u);r.interpolation===`CUBICSPLINE`&&this._createCubicSplineTrackInterpolant(n),a.push(n)}return a}_getArrayFromAccessor(e){let t=e.array;if(e.normalized){let e=Hd(t.constructor),n=new Float32Array(t.length);for(let r=0,i=t.length;r<i;r++)n[r]=t[r]*e;t=n}return t}_createCubicSplineTrackInterpolant(e){e.createInterpolant=function(e){return new(this instanceof go?Td:Cd)(this.times,this.values,this.getValueSize()/3,e)},e.createInterpolant.isInterpolantFactoryMethodGLTFCubicSpline=!0}};function Kd(e,t,n){let r=t.attributes,i=new rr;if(r.POSITION!==void 0){let e=n.json.accessors[r.POSITION],t=e.min,a=e.max;if(t!==void 0&&a!==void 0){if(i.set(new W(t[0],t[1],t[2]),new W(a[0],a[1],a[2])),e.normalized){let t=Hd(Dd[e.componentType]);i.min.multiplyScalar(t),i.max.multiplyScalar(t)}}else{console.warn(`THREE.GLTFLoader: Missing min/max properties for accessor POSITION.`);return}}else return;let a=t.targets;if(a!==void 0){let e=new W,t=new W;for(let r=0,i=a.length;r<i;r++){let i=a[r];if(i.POSITION!==void 0){let r=n.json.accessors[i.POSITION],a=r.min,o=r.max;if(a!==void 0&&o!==void 0){if(t.setX(Math.max(Math.abs(a[0]),Math.abs(o[0]))),t.setY(Math.max(Math.abs(a[1]),Math.abs(o[1]))),t.setZ(Math.max(Math.abs(a[2]),Math.abs(o[2]))),r.normalized){let e=Hd(Dd[r.componentType]);t.multiplyScalar(e)}e.max(t)}else console.warn(`THREE.GLTFLoader: Missing min/max properties for accessor POSITION.`)}}i.expandByVector(e)}e.boundingBox=i;let o=new Dr;i.getCenter(o.center),o.radius=i.min.distanceTo(i.max)/2,e.boundingSphere=o}function qd(e,t,n){let r=t.attributes,i=[];function a(t,r){return n.getDependency(`accessor`,t).then(function(t){e.setAttribute(r,t)})}for(let t in r){let n=jd[t]||t.toLowerCase();n in e.attributes||i.push(a(r[t],n))}if(t.indices!==void 0&&!e.index){let r=n.getDependency(`accessor`,t.indices).then(function(t){e.setIndex(t)});i.push(r)}return K.workingColorSpace!==`srgb-linear`&&`COLOR_0`in r&&console.warn(`THREE.GLTFLoader: Converting vertex colors from "srgb-linear" to "${K.workingColorSpace}" not supported.`),Ld(e,t),Kd(e,t,n),Promise.all(i).then(function(){return t.targets===void 0?e:Rd(e,t.targets,n)})}var Jd=8648153,Yd=16749678,Xd=class{constructor(e,t){this.container=e,this.game=t,this.scene=new Hn,this.camera=new Xo,this.blood=new Bu,this.appearances=[],this.loader=new Yu,this.models=[],this.visuals=[],this.shadows=[],this.indicators=[],this.roleModels=[],this.activeRoles=[],this.warnings=[],this.effects=[],this.projectiles=new Map,this.supplyMeshes=new Map,this.followTarget=new W,this.followed=null,this.mouse=null,this.particleTexture=null,this.kick=new U,this.disposed=!1,this.width=1,this.height=1,this.shake=0,this.ray=new ys,this.ground=new Qi(new W(0,1,0),0),this.audio=null,this.muted=!1,this.audioNeedsReset=!1,this.audioCapture=null,this.recordingCanvas=null,this.recorder=null,this.recordingTimer=0,this.renderer=new zu({antialias:!0,alpha:!1,powerPreference:`high-performance`}),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,1.8)),this.renderer.setClearColor(1055778),this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=1,this.renderer.outputColorSpace=qe,this.renderer.toneMapping=4,this.renderer.toneMappingExposure=1.2,this.renderer.domElement.setAttribute(`aria-label`,`青石坪，游剑与长枪的三维练武场`),e.appendChild(this.renderer.domElement),this.scene.fog=new Vn(1055778,.019),this.scene.add(new No(14809325,1582380,2.3));let n=new Qo(16769462,3.4);n.position.set(-7,15,7),n.castShadow=!0,n.shadow.mapSize.set(1024,1024),n.shadow.camera.left=-22,n.shadow.camera.right=22,n.shadow.camera.top=22,n.shadow.camera.bottom=-22,n.shadow.bias=-.001,this.scene.add(n);let r=new Qo(5684142,1.6);r.position.set(6,5,-8),this.scene.add(r);let i=new X(new Ia(200,200),new Xa({color:1122085,roughness:1}));i.rotation.x=-Math.PI/2,i.position.y=-1,i.receiveShadow=!0,this.scene.add(i),this.ghost=new da(new Fr().setFromPoints([new W,new W(1,0,0)]),new eo({color:Jd,dashSize:.18,gapSize:.13,transparent:!0,opacity:.45})),this.scene.add(this.ghost),this.scene.add(this.blood.group),this.ready=this.load(),this.resize()}async load(){let e=await Promise.all([`arena`,`sword`,`spear`,`fist`,`dagger`].map(e=>this.loader.loadAsync(new URL(`models/`+e+`.glb`,document.baseURI).href)));if(this.disposed){for(let t of e)this.release(t.scene);return}let t=e[0].scene;t.scale.set(s,1,s),t.updateMatrixWorld(!0);let n=new Map;t.traverse(e=>{if(e instanceof X&&!Array.isArray(e.material)){let t=e.geometry.clone().applyMatrix4(e.matrixWorld),r=n.get(e.material)||[];r.push(t),n.set(e.material,r)}});for(let[e,t]of n){let n=Wu(t);if(n){let t=new X(n,e);t.receiveShadow=!0,t.castShadow=!0,this.scene.add(t)}for(let e of t)e.dispose()}t.traverse(e=>{e instanceof X&&e.geometry.dispose()});for(let e of a){let t=new X(new ja(e.r*.83,e.r,e.height,e.height>1?6:9),new Xa({color:e.height>1?5597538:8556932,roughness:.92}));t.position.set(e.x,e.height/2,e.y),t.castShadow=!0,t.receiveShadow=!0,this.scene.add(t);let n=this.mesh(new La(e.r*.65,e.r*.78,32),12100719,.6);n.rotation.x=-Math.PI/2,n.position.set(e.x,e.height+.01,e.y),this.scene.add(n)}for(let e of i){let t=this.mesh(new La(.65,.7,48),12893073,.4);t.rotation.x=-Math.PI/2,t.position.set(e.x,.035,e.y),this.scene.add(t)}for(let t=0;t<2;t++){let n={};for(let[t,r]of[`sword`,`spear`,`fist`,`dagger`].entries())n[r]=e[t+1].scene.clone(!0),n[r].traverse(e=>{e instanceof X&&(e.castShadow=!0,e.receiveShadow=!0,e.material=e.material.clone())});this.roleModels.push(n);let r=t===0?this.game.player.role:this.game.enemy.role,i=n[r];this.activeRoles[t]=r,i.traverse(e=>{e instanceof X&&(e.castShadow=!0,e.receiveShadow=!0,e.material=e.material.clone())});let a=new Nn,o=new Nn;o.position.y=1,i.position.y=-1,o.add(i),a.add(o),this.models.push(a),this.visuals.push(o),this.scene.add(a);let s=new Vu;for(let e of Object.values(n))s.prepare(e);a.add(s.group),this.appearances.push(s);let c=new X(new Aa(.55,24),new di({color:531227,transparent:!0,opacity:.5,depthWrite:!1}));c.rotation.x=-Math.PI/2,this.shadows.push(c),this.scene.add(c);let l=new X(new La(.55,.6,32),new di({color:t===0?Jd:Yd,side:2,transparent:!0,opacity:.85,depthWrite:!1}));l.rotation.x=-Math.PI/2,this.indicators.push(l),this.scene.add(l);let u=new Nn;this.warnings.push(u),this.scene.add(u)}}findJoint(e,t){let n;return e.traverse(e=>{RegExp(`^`+t+`([._]?0+[1-9])?$`).test(e.name)&&(n=e)}),n}resize(){if(this.width=this.container.clientWidth,this.height=this.container.clientHeight,!this.width||!this.height)return;this.renderer.setSize(this.width,this.height);let e=this.width/this.height,t=Math.max(21,27/e);this.camera.left=-t*e/2,this.camera.right=t*e/2,this.camera.top=t/2,this.camera.bottom=-t/2,this.camera.near=.1,this.camera.far=120,this.camera.position.set(0,25,19),this.camera.lookAt(0,0,0),this.camera.updateProjectionMatrix(),this.camera.updateMatrixWorld()}clearPointer(){this.mouse=null}aimAt(e,t){return this.mouse={x:e,y:t},this.pointerAim(e,t)}pointerAim(e,t){let n=this.container.getBoundingClientRect();this.ray.setFromCamera(new U((e-n.left)/n.width*2-1,-(t-n.top)/n.height*2+1),this.camera);let r=this.ray.ray.intersectPlane(this.ground,new W);return r?Math.atan2(r.z-this.game.player.y,r.x-this.game.player.x):this.game.aim}screenPoint(e){let t=new W(e.x,e.z+2.3,e.y).project(this.camera);return{x:(t.x*.5+.5)*this.width,y:(-.5*t.y+.5)*this.height}}get desktopSafari(){return/Safari/.test(navigator.userAgent)&&!/Chrome|Chromium|Edg/.test(navigator.userAgent)&&!(/iPhone|iPad|iPod/.test(navigator.userAgent)||navigator.maxTouchPoints>1)}get audioState(){return this.muted?`muted`:this.audioNeedsReset?`suspended`:this.audio?.state||`suspended`}setMuted(e){this.muted=e}invalidateAudio(){this.desktopSafari&&this.audio&&(this.audioNeedsReset=!0)}async unlockAudio(){if(this.disposed||this.muted)return!1;try{let e=navigator,t=/iPhone|iPad|iPod/.test(navigator.userAgent)||navigator.maxTouchPoints>1;try{t&&e.audioSession&&(e.audioSession.type=`playback`)}catch{}let n=window.AudioContext||window.webkitAudioContext;if(!n)return!1;if(this.audioNeedsReset&&this.recorder?.state!==`recording`){let e=this.audio;this.audio=null,this.audioCapture=null,this.audioNeedsReset=!1,e?.close().catch(()=>{})}if(!this.audio||this.audio.state===`closed`){this.audio=new n(this.desktopSafari?{sampleRate:48e3,latencyHint:`interactive`}:void 0);let e=this.audio.createBufferSource();e.buffer=this.audio.createBuffer(1,1,this.audio.sampleRate),e.connect(this.audio.destination),e.onended=()=>e.disconnect(),e.start()}let r=this.audio;return r.state!==`running`&&await r.resume(),!this.disposed&&r===this.audio&&r.state===`running`}catch{return!1}}async testAudio(){if(this.muted=!1,this.desktopSafari&&(this.audioNeedsReset=!0),!await this.unlockAudio())return!1;let e=this.audio,t=e.currentTime;for(let n=0;n<3;n++){let r=e.createOscillator(),i=e.createGain(),a=t+n*.4;r.frequency.value=[440,660,880][n],r.connect(i),i.connect(e.destination),i.gain.setValueAtTime(0,a),i.gain.linearRampToValueAtTime(.16,a+.015),i.gain.setValueAtTime(.16,a+.18),i.gain.linearRampToValueAtTime(0,a+.25),r.onended=()=>{r.disconnect(),i.disconnect()},r.start(a),r.stop(a+.27)}return!0}record(e,t){if(typeof MediaRecorder>`u`)throw Error(`此浏览器不支持录制，请使用 Chrome。`);this.unlockAudio(),this.audio&&(this.audioCapture??=this.audio.createMediaStreamDestination()),this.recordingCanvas=document.createElement(`canvas`),this.recordingCanvas.width=1280,this.recordingCanvas.height=720;let n=this.recordingCanvas.captureStream(30);for(let e of this.audioCapture?.stream.getAudioTracks()||[])n.addTrack(e);let r=[`video/webm;codecs=vp9,opus`,`video/webm;codecs=vp8,opus`,`video/mp4`].find(e=>MediaRecorder.isTypeSupported(e));this.recorder=new MediaRecorder(n,{mimeType:r,videoBitsPerSecond:45e5});let i=[],a=this.recorder;a.ondataavailable=e=>{e.data.size&&i.push(e.data)},a.onstop=()=>{this.recordingCanvas=null;for(let e of n.getVideoTracks())e.stop();t(new Blob(i,{type:a.mimeType}))},a.start(),this.recordingTimer=window.setTimeout(()=>{a.state===`recording`&&a.stop()},e*1e3)}sound(e){if(this.muted)return;let t=this.audio;if(!t||this.muted||t.state!==`running`)return;let n=t.currentTime,r=()=>Math.random()-.5,i=e.kind===`hit`,a=e.kind===`block`||e.kind===`clash`||e.kind===`swing`&&!!e.finisher,o=e.kind===`perfect`||e.kind===`break`||e.kind===`ultimate`||e.kind===`counterstep`,s=e.kind===`hit`?Math.min(1,(e.value||12)/28):e.heavy||e.finisher?1:.4,c=(1+r()*(i?.16:a?.1:.08))*(e.heavy?1.08:1),l=Math.max(.08,(i?.13:a?.17:o?.22:.18)*(1+r()*.18)),u=(a?1300:i?220-s*80:e.kind===`land`?100:o?620:420)*c,d=(a?450:i?48:e.kind===`land`?40:o?180:130)*c,f=t.createOscillator(),p=t.createGain(),m=t.createStereoPanner();if(f.connect(p),p.connect(m),m.connect(t.destination),this.audioCapture&&m.connect(this.audioCapture),m.pan.value=Math.max(-.5,Math.min(.5,(e.owner===0?-.12:.12)+r()*.28)),f.type=a?`triangle`:e.heavy||o?`square`:`sine`,f.frequency.setValueAtTime(u,n),f.frequency.exponentialRampToValueAtTime(Math.max(24,d),n+l*.72),p.gain.setValueAtTime(1e-4,n),p.gain.exponentialRampToValueAtTime((i?.1+s*.07:a?.12:o?.07:.04)*(1+r()*.12),n+.004),p.gain.exponentialRampToValueAtTime(1e-4,n+l),f.onended=()=>{f.disconnect(),p.disconnect(),m.disconnect()},f.start(n),f.stop(n+l+.02),i||a||o||e.kind===`swing`){let e=Math.max(.04,(i?.045+s*.045:a?.12:o?.16:.1)*(1+r()*.25)),c=t.createBuffer(1,Math.ceil(t.sampleRate*e),t.sampleRate),l=c.getChannelData(0);for(let e=0;e<l.length;e++)l[e]=(Math.random()*2-1)*(1-e/l.length)**(i?.7:.45);let u=t.createBufferSource(),d=t.createBiquadFilter(),f=t.createGain(),p=t.createStereoPanner();u.buffer=c,d.type=`highpass`,d.frequency.value=(a?2600:i?650:o?1100:1700)*(1+r()*.18),f.gain.value=(i?.13:a?.07:o?.08:.055)*(1+r()*.2),p.pan.value=Math.max(-.55,Math.min(.55,m.pan.value+r()*.2)),u.connect(d),d.connect(f),f.connect(p),p.connect(t.destination),this.audioCapture&&p.connect(this.audioCapture),u.onended=()=>{u.disconnect(),d.disconnect(),f.disconnect(),p.disconnect()},u.start(n)}}mesh(e,t,n=.85){return new X(e,new di({color:t,transparent:!0,opacity:n,side:2,depthWrite:!1}))}fx(e,t,n,r){if(this.effects.length>=400){let e=this.effects.shift();this.scene.remove(e.object),this.release(e.object)}this.scene.add(e),this.effects.push({object:e,life:t,max:t,kind:n,velocity:r})}motes(e,t,n,r,i,a=3,o){if(!this.particleTexture){let e=document.createElement(`canvas`);e.width=32,e.height=32;let t=e.getContext(`2d`),n=t.createRadialGradient(16,16,0,16,16,16);n.addColorStop(0,`#fff`),n.addColorStop(.2,`#ffffffee`),n.addColorStop(.55,`#ffffff55`),n.addColorStop(1,`#ffffff00`),t.fillStyle=n,t.fillRect(0,0,32,32),this.particleTexture=new Ta(e)}let s=new Float32Array(n*3),c=new Float32Array(n*3),l=new Float32Array(n*3),u=new J(t);for(let e=0;e<n;e++){let t=o===void 0?Math.random()*Math.PI*2:o+(Math.random()-.5)*2.4,n=r*(.25+Math.random()*.75);s[e*3]=(Math.random()-.5)*.12,s[e*3+1]=(Math.random()-.5)*.12,s[e*3+2]=(Math.random()-.5)*.12,c[e*3]=Math.cos(t)*n,c[e*3+1]=Math.random()*r*.65+.2,c[e*3+2]=Math.sin(t)*n,u.clone().lerp(new J(16777215),Math.random()*.55).toArray(l,e*3)}let d=new Fr;d.setAttribute(`position`,new xr(s,3)),d.setAttribute(`color`,new xr(l,3));let f=new Sa(d,new _a({size:2.6,map:this.particleTexture,vertexColors:!0,transparent:!0,opacity:.85,depthWrite:!1,blending:2,toneMapped:!1}));f.frustumCulled=!1,f.position.copy(e),f.userData.velocities=c,f.userData.gravity=a,this.fx(f,i,`motes`)}damageLabel(t){let n=t.hpDamage||0,r=t.absorbed||0;if(n+r<=0)return;let i=this.effects.filter(e=>e.kind===`damage-label`);if(i.length>=24){let e=i[0];this.effects.splice(this.effects.indexOf(e),1),this.scene.remove(e.object),this.release(e.object)}let a=document.createElement(`canvas`);a.width=384,a.height=144;let o=a.getContext(`2d`),s=e=>e<1?e.toFixed(1):String(Math.round(e));o.textAlign=`center`,o.lineJoin=`round`,o.strokeStyle=`#10212b`,o.lineWidth=7,o.font=`bold 58px sans-serif`;let c=n>0?`−`+s(n):`化劲`;if(o.strokeText(c,192,64),o.fillStyle=n>0?t.kind===`dot`?`#ffb36b`:`#fff3db`:`#94f6e1`,o.fillText(c,192,64),r>0){o.font=`bold 30px sans-serif`;let t=`耐力 −`+s(r*e);o.strokeText(t,192,108),o.fillStyle=`#94f6e1`,o.fillText(t,192,108)}let l=new ti(new Vr({map:new Ta(a),transparent:!0,depthTest:!1,depthWrite:!1,toneMapped:!1}));l.name=`combat-damage-label`,l.renderOrder=100;let u=i.length%3-1;l.position.set(t.x+u*.45,t.z+1.5,t.y),l.scale.set(3.5,1.32,1),this.fx(l,1.05,`damage-label`,new W(u*.2,.8,0))}afterimage(e){let t=this.models[e.owner];if(!t)return;t.updateMatrixWorld(!0);let n=[];if(t.traverse(e=>{if(e instanceof X){let t=e.geometry.clone().applyMatrix4(e.matrixWorld);for(let e of Object.keys(t.attributes))e!==`position`&&t.deleteAttribute(e);n.push(t)}}),!n.length)return;let r=Wu(n);for(let e of n)e.dispose();if(!r)return;let i=e.owner===0?this.game.player:this.game.enemy,a=e.kind===`block`,o=a?e.angle:Math.hypot(i.dx,i.dy)>.1?Math.atan2(i.dy,i.dx):e.angle;for(let n=0;n<3;n++){if(this.effects.filter(e=>e.kind===`afterimage`).length>=12){let e=this.effects.findIndex(e=>e.kind===`afterimage`),t=this.effects.splice(e,1)[0];this.scene.remove(t.object),this.release(t.object)}let i=new X(r.clone(),new di({color:a?16767367:9240560,transparent:!0,opacity:.18-n*.035,depthWrite:!1,blending:1,toneMapped:!1}));i.name=`combat-afterimage`;let s=(a?.25:.4)+n*(a?.35:.48);i.position.set(e.x-t.position.x-Math.cos(o)*s,e.z-t.position.y+(a?0:n*.025),e.y-t.position.z-Math.sin(o)*s),this.fx(i,.3+n*.1,`afterimage`,new W(-Math.cos(o)*(a?.65:1),a?.06:.12,-Math.sin(o)*(a?.65:1)))}r.dispose()}impact(e,t){let n=e.kind===`block`||e.kind===`clash`,r=e.kind===`hit`&&(e.hpDamage||0)>0,i=n||e.kind===`break`||(e.value||0)>=22,a=new W(e.x,e.kind===`hit`?e.z:e.z+.65,e.y);this.motes(a,r?16732768:n?16764786:t,i?34:r?26:18,i?4.5:r?3.4:2.8,i?.48:r?.42:.32,8,e.angle);let o=this.mesh(new Ia(i?.5:.3,.055),16775388,1);o.position.copy(a),o.quaternion.copy(this.camera.quaternion),o.rotation.z=.7,this.fx(o,.075,`flash`);let s=new Nn;s.position.copy(a);for(let r=0;r<(i?9:5);r++){let r=e.angle+(Math.random()-.5)*2.7,i=.18+Math.random()*.42,a=new da(new Fr().setFromPoints([new W(Math.cos(r)*.12,0,Math.sin(r)*.12),new W(Math.cos(r)*i,.05,Math.sin(r)*i)]),new ra({color:n?16772541:t,transparent:!0,opacity:.9,depthWrite:!1,blending:2}));s.add(a)}if(this.fx(s,.14,`impact-rays`),this.kick.set(Math.cos(e.angle),Math.sin(e.angle)).multiplyScalar(i?.095:.04),i||r){let e=this.mesh(new La(r?.18:.28,r?.205:.305,48),r?16732768:t,r?.62:.45);e.position.copy(a),e.rotation.x=-Math.PI/2,this.fx(e,r?.18:.22,`ring`)}}comboEffect(e){if(!e.finisher)return;let t=e.finisher,n=e.element&&e.element!==`none`?r[e.element].color:t===`launch`?11004671:t===`spin`?8978400:t===`lunge`?13218047:t===`cleave`?16760695:15070719,i=new W(Math.cos(e.angle),0,Math.sin(e.angle)),a=new W(-Math.sin(e.angle),0,Math.cos(e.angle));for(let r=0;r<24;r++){let o=r/23,s=o*Math.PI*2,c=this.mesh(new Fa(t===`cleave`?.12:.085),n,.9),l=new W;c.position.set(e.x,e.z+.6,e.y),t===`launch`?(c.position.addScaledVector(i,.5+o*1.8),c.position.y+=Math.sin(o*Math.PI)*1.4,l.copy(i).multiplyScalar(1.2),l.y=2+o*3):t===`spin`?(c.position.x+=Math.cos(s)*2.5,c.position.z+=Math.sin(s)*2.5,l.set(-Math.sin(s)*3,.8,Math.cos(s)*3)):t===`cleave`?(c.position.addScaledVector(i,1.3+o),c.position.y=e.z+.12,l.copy(a).multiplyScalar((r%2?1:-1)*(1+o*4)),l.y=1+o*2):(c.position.addScaledVector(i,o*3.2),c.position.addScaledVector(a,Math.sin(s*2)*.18),l.copy(i).multiplyScalar(t===`lunge`?5:3),l.y=.6),c.material.toneMapped=!1,c.scale.set(1,t===`launch`?2.5:1.4,1),this.fx(c,.25+o*.2,`combo-spark`,l)}if(t===`spin`||t===`cleave`){let r=this.mesh(new La(t===`spin`?2.3:.4,t===`spin`?2.4:.48,48),n,.7);r.rotation.x=-Math.PI/2,r.position.set(e.x+(t===`cleave`?i.x*1.8:0),e.z+.08,e.y+(t===`cleave`?i.z*1.8:0)),this.fx(r,.32,`ring`)}if(t===`lunge`||t===`pierce`)for(let t=0;t<3;t++){let r=this.mesh(new Ia(2.5,.035),n,.55);r.rotation.x=-Math.PI/2,r.rotation.z=-e.angle,r.position.set(e.x+i.x*1.3+a.x*(t-1)*.28,e.z+.65,e.y+i.z*1.3+a.z*(t-1)*.28),this.fx(r,.24,`streak`)}}bladeTrail(e,t,n,r,i=!1,a=!0){let o=new Nn,s=(e,t,n,r,i,a,s)=>{let c=[],l=[],u=[],d=new J(i);for(let i=0;i<=52;i++){let a=i/52,o=t+n*a,f=Math.sin(Math.PI*a)**.75*(.4+.6*a),p=1+.16*Math.sin(a*61+s*2)+.07*Math.sin(a*137),m=e+.035*Math.sin(a*13+s),h=r*f*p;for(let e=0;e<2;e++){let t=m-(e?h:0);c.push(Math.cos(o)*t,.018*s+.035*Math.sin(a*8),Math.sin(o)*t);let n=d.clone().multiplyScalar((e?.22:1)*(.15+.85*Math.sin(Math.PI*a)));l.push(n.r,n.g,n.b)}if(i<52){let e=i*2;u.push(e,e+1,e+2,e+1,e+3,e+2)}}let f=new Fr;f.setAttribute(`position`,new Y(c,3)),f.setAttribute(`color`,new Y(l,3)),f.setIndex(u),o.add(new X(f,new di({vertexColors:!0,transparent:!0,opacity:a,side:2,depthWrite:!1,blending:2,toneMapped:!1})))};s(e,t,n,i?.38:.22,r,.55,0),s(e+.012,t+n*.07,n*.91,.035,15400959,.9,1);for(let i=0;i<(a?7:0);i++){let a=t+n*(.03+i*.065),o=n*(.32+i%3*.14);s(e-.07-i*.046,a,o,.009+i%2*.01,i%3?r:16056319,.36+i%2*.15,i+2)}let c=[];for(let r=0;r<(a?16:0);r++){let i=t+r/16*n,a=e+.04+r%4*.045,o=.015+r%3*.035;c.push(Math.cos(i)*a,.04,Math.sin(i)*a,Math.cos(i+.018)*a,.04,Math.sin(i+.018)*a,Math.cos(i+o)*(a+.07),.055,Math.sin(i+o)*(a+.07))}let l=new Fr;return l.setAttribute(`position`,new Y(c,3)),o.add(new X(l,new di({color:r,transparent:!0,opacity:.6,side:2,depthWrite:!1,blending:2,toneMapped:!1}))),o}elemental(e){if(!e.element||e.element===`none`)return;let t=r[e.element].color,n=e.stage===5?10:4;this.motes(new W(e.x+Math.cos(e.angle)*.8,e.z+.7,e.y+Math.sin(e.angle)*.8),t,e.stage===5?28:12,e.element===`fire`?1.5:2,e.element===`water`?.65:.45,e.element===`fire`?-1:2,e.angle);for(let r=0;r<n;r++){let i=r/n,a=e.angle+(i-.5)*2.2,o=.9+i*1.5,s=new W(e.x+Math.cos(a)*o,e.z+.6,e.y+Math.sin(a)*o);if(e.element===`metal`){let e=new da(new Fr().setFromPoints([s,s.clone().add(new W(Math.cos(a)*.65,.07,Math.sin(a)*.65))]),new ra({color:t,transparent:!0,opacity:.8,depthWrite:!1}));this.fx(e,.2,`metal-streak`)}else if(e.element===`water`){let e=this.mesh(new La(.12,.135,24),t,.55);e.rotation.x=-Math.PI/2,e.position.copy(s),this.fx(e,.42,`ring`)}else if(e.element===`wood`){let e=this.mesh(new Ia(.09,.26),t,.8);e.position.copy(s),e.rotation.set(-.8,a,.6),this.fx(e,.6,`leaf`,new W(Math.cos(a)*.7,1,Math.sin(a)*.7))}else if(e.element===`earth`){let e=this.mesh(new Pa(.09,0),t,.75);e.position.copy(s),this.fx(e,.45,`stone`,new W(Math.cos(a),1.4,Math.sin(a)))}else{let e=this.bladeTrail(.22,-1,2.6,t,!1,!1);e.position.copy(s),e.rotation.z=.7,e.scale.set(.6,1,1.4),this.fx(e,.28,`ember`,new W(.1,1.8,.1))}}}consume(e){for(let t of e){if(this.blood.hit(t),(t.kind===`hit`||t.kind===`dot`)&&this.damageLabel(t),t.kind===`dot`)continue;this.sound(t),(t.kind===`perfect`||t.kind===`block`||t.kind===`counterstep`&&t.riposte||t.kind===`jump`&&t.reason===`dodge`&&t.z>.2)&&this.afterimage(t);let e=t.element&&t.element!==`none`?r[t.element].color:t.form?n[t.form].tint:t.owner===0?Jd:Yd;if((t.kind===`swing`||t.kind===`jump`)&&this.elemental(t),t.kind===`guard`||t.kind===`stance`){let e=this.mesh(new La(1.1,1.25,40,1,-1.2,2.4),t.kind===`guard`?16768133:16777215,.85);e.rotation.x=-Math.PI/2,e.rotation.z=t.angle,e.position.set(t.x,t.z+.15,t.y),this.fx(e,.48,`ring`)}if(t.kind===`swing`&&t.finisher&&this.comboEffect(t),t.kind===`swing`&&t.aerial&&this.motes(new W(t.x,t.z+.8,t.y),e,t.aerial===`skywave`?28:14,2.5,.4,1,t.angle),t.kind===`swing`&&t.move!==`wave`){if(t.power){let e=this.mesh(new La(.8,1,40),t.power===2?12951807:8517084,.6);e.rotation.x=-Math.PI/2,e.position.set(t.x,t.z+.12,t.y),e.scale.setScalar(t.power===2?2.8:2),this.fx(e,.35,`ring`)}let r=new Nn;if(r.position.set(t.x,t.z+(t.guardBreak?.28:t.move===`sweep`?.42:.85),t.y),t.guardBreak){let n=this.bladeTrail(1.45,-.95,1.9,e,!0,!1);n.rotation.x=Math.PI/2,n.scale.set(1.1,.72,1),r.add(n),r.rotation.y=-t.angle,this.motes(new W(t.x+Math.cos(t.angle)*.7,t.z+.22,t.y+Math.sin(t.angle)*.7),e,16,2.2,.26,2,t.angle)}else if(t.move===`thrust`||t.finisher===`pierce`||t.finisher===`lunge`){let n=t.finisher===`lunge`?3.6:t.finisher===`pierce`?2.9:3.35,i=this.mesh(new Ia(n,.22),e);i.rotation.x=-Math.PI/2,i.position.x=n/2,r.add(i),r.rotation.y=-t.angle}else if(t.finisher===`launch`||t.finisher===`cleave`){let n=this.bladeTrail(2.1,t.finisher===`launch`?-.6:0,1.9,e,!0);n.rotation.x=Math.PI/2,r.add(n),r.rotation.y=-t.angle}else{let n=t.finisher===`spin`?2.85:t.move===`sweep`?3.1:2.3,i=t.finisher===`spin`?Math.PI:t.move===`sweep`?1.45:1.05;r.add(this.bladeTrail(n,-i,i*2,e,!!t.heavy)),r.rotation.y=-t.angle}r.scale.setScalar((t.form?n[t.form].range:t.power===2?1.65:t.power?1.35:1)*(1+(t.charge||0)*.3)),r.userData.spin=t.stage===3||t.move===`thrust`?0:t.stage===2?-7:7,this.fx(r,t.stage===3?.26:.18,`slash`)}if((t.kind===`hit`||t.kind===`clash`||t.kind===`block`||t.kind===`break`)&&(this.impact(t,e),this.shake=t.kind===`clash`||t.kind===`block`||t.kind===`break`||(t.value||0)>=22?.14:.075),(t.kind===`pickup`||t.kind===`counterstep`)&&this.motes(new W(t.x,t.z+.7,t.y),t.kind===`counterstep`?16768913:t.element===`metal`?13015551:8650665,24,2,.55,-1),t.kind===`perfect`||t.kind===`ultimate`){for(let e=0;e<3;e++){let n=this.mesh(new La(.5+e*.2,.55+e*.2,40),t.kind===`perfect`?11534320:15252479,.85);n.rotation.x=-Math.PI/2,n.position.set(t.x,t.z+.15+e*.4,t.y),this.fx(n,.65,`ring`)}t.kind===`ultimate`&&(this.shake=.18)}if(t.kind===`land`)for(let e=0;e<10;e++){let n=this.mesh(new Fa(.09),11056548,.3);n.position.set(t.x,.12,t.y);let r=e/10*Math.PI*2;this.fx(n,.3+Math.random()*.2,`dust`,new W(Math.cos(r)*2,.5+Math.random(),Math.sin(r)*2))}if(t.kind===`jump`||t.kind===`land`||t.kind===`block`||t.kind===`break`){let n=this.mesh(new La(.5,.56,32),t.kind===`block`?16768913:e,.8);n.rotation.x=-Math.PI/2,n.position.set(t.x,.055,t.y),this.fx(n,.4,`ring`)}}}warning(e,t){let n=this.warnings[t];if(!n)return;let r=e.attack,i=r&&!r.fired?r.kind:``;if(n.userData.kind!==i){for(let e of[...n.children])n.remove(e),this.release(e);if(n.userData.kind=i,i){let e;i===`thrust`||i===`wave`?(e=this.mesh(new Ia(i===`thrust`?3.35:7,.55),Yd,.22),e.position.x=i===`thrust`?1.67:3.5):e=this.mesh(new Aa(3.1,40,-1.45,2.9),Yd,.2),e.rotation.x=-Math.PI/2,n.add(e)}}n.position.set(e.x,.055,e.y),n.rotation.y=-(r?.angle??e.angle);for(let e of n.children)e instanceof X&&(e.material.opacity=.1+.28*(r?r.age/r.windup:0))}render(e){if(this.disposed)return;this.kick.multiplyScalar(Math.exp(-22*e)),this.shake=Math.max(0,this.shake-e*1.1);let i=this.game.player,a=this.container.getBoundingClientRect(),s=this.mouse&&this.game.running&&this.game.mode!==`spectate`?Hu((this.mouse.x-a.left)/Math.max(1,a.width)*2-1,(this.mouse.y-a.top)/Math.max(1,a.height)*2-1):{x:0,y:0},c=this.game.mode===`spectate`,l=this.game.enemy,u=c?new W((i.x+l.x)/2,Math.max(i.z,l.z)*.5,(i.y+l.y)/2):new W(i.x+s.x,i.z*.7,i.y+s.y),d=this.width/Math.max(1,this.height),f=Math.max(21,27/d),p=c?Math.max(f,Math.abs(i.x-l.x)/d+8,Math.abs(i.y-l.y)*.8+10):f,m=this.camera.top-this.camera.bottom,h=m+(p-m)*Uu(e);this.camera.left=-h*d/2,this.camera.right=h*d/2,this.camera.top=h/2,this.camera.bottom=-h/2,this.camera.updateProjectionMatrix(),this.followed===i?this.game.paused||this.followTarget.lerp(u,Uu(e)):(this.followed=i,this.followTarget.copy(u));let g=this.followTarget;this.camera.position.set(g.x+Math.sin(performance.now()*.1)*this.shake+this.kick.x,25+g.y,19+g.z+Math.cos(performance.now()*.09)*this.shake+this.kick.y),this.camera.lookAt(g),this.camera.updateMatrixWorld(),this.mouse&&this.game.running&&!this.game.paused&&!c&&(this.game.aim=this.pointerAim(this.mouse.x,this.mouse.y));for(let i of[this.game.player,this.game.enemy]){let a=this.models[i.id];if(!a)continue;if(this.activeRoles[i.id]!==i.role){let e=this.visuals[i.id];e.clear();let t=this.roleModels[i.id][i.role];t.position.y=-1,e.add(t),this.activeRoles[i.id]=i.role}this.game.mode===`lan`&&e>0?a.position.lerp(new W(i.x,i.z,i.y),1-Math.exp(-35*e)):a.position.set(i.x,i.z,i.y),a.rotation.y=Math.PI/2-i.angle;let s=this.findJoint(a,`Torso`),c=e=>this.findJoint(a,e);s&&(s.position.y=i.moving?Math.sin(i.stride*2)*.028:Math.sin(this.game.time*3)*.014);let l=c(`ArmR`),u=c(`ArmL`),d=c(`LegL`),f=c(`LegR`);for(let e of[l,u,d,f])e&&(e.rotation.z=0);if(d&&(d.rotation.x=i.z>.2?-.7:Math.sin(i.stride)*.45*!!i.moving),f&&(f.rotation.x=i.z>.2?.5:-Math.sin(i.stride)*.45*!!i.moving),l){l.userData.rest??=l.position.clone(),l.position.copy(l.userData.rest);let e=0,t=0,n=i.attack;if(n){let r=n.age/n.windup,a=n.stage||1,o=a===2?-1:1;if(n.guardBreak)e=0,t=n.fired?-.15:.48;else if(n.finisher===`launch`||n.finisher===`cleave`){let e=Math.max(0,1-(n.age-n.windup)/.35);t=n.fired?(n.finisher===`launch`?-1.6:1.1)*e:(n.finisher===`launch`?.7:-1.8)*Math.min(r,1)}else n.finisher===`spin`?e=n.fired?(n.age-n.windup)/.35*Math.PI*2:-.8*Math.min(r,1):n.finisher===`pierce`||n.finisher===`lunge`||n.kind===`thrust`||i.role===`spear`&&n.kind===`slash`?(e=-.12,t=n.fired?-.45:.35,l.position.z+=n.fired?-Math.max(0,1-(n.age-n.windup)/.35)*.75:Math.min(1,r)*.3):n.fired?(e=Math.max(0,1-(n.age-n.windup)/.25)*1.6*o,t=-.16):(e=-Math.min(1,r)*1.25*o,t=.12);s&&(s.rotation.y=n.finisher===`spin`?e:a===3?0:e*.22)}else s&&(s.rotation.y=0);l.rotation.y=e,l.rotation.x=i.guard>0?-1.15:t}u&&(u.rotation.x=i.guard>0?-.8:Math.sin(i.stride)*.2*!!i.moving);let p=this.visuals[i.id],m=c(`KneeL`),h=c(`KneeR`),g=c(`ElbowL`),_=c(`ElbowR`),v=e=>(e=Math.max(0,Math.min(1,e)),e*e*(3-2*e));if(p){if(p.userData.serial!==i.acroSerial&&(p.userData.serial=i.acroSerial,p.userData.fromX=p.rotation.x,p.userData.fromZ=p.rotation.z),p.position.y=1,p.rotation.z=0,p.rotation.y=0,i.acro===`jump`)p.rotation.x=v(i.acroAge/.65)*Math.PI*2;else if(i.acro===`double`){let e=v(i.acroAge/.62);p.rotation.x=(p.userData.fromX||0)+(Math.PI*2-(p.userData.fromX||0))*e,p.rotation.z=e*Math.PI*2}else i.acro===`dodge`?(i.z>.2?(p.rotation.z=v(i.acroAge/.34)*Math.PI*2,p.rotation.x=.4):p.rotation.x=v(i.acroAge/.34)*Math.PI*2,p.position.y=.92):(p.rotation.x=0,p.rotation.z=0,i.acro===`land`&&(p.position.y-=Math.sin(Math.min(1,i.acroAge/.24)*Math.PI)*.19));let e=i.loadout.qinggong||`swallow`;if(i.acro===`jump`||i.acro===`double`||i.acro===`dodge`){let t=v(i.acroAge/(i.acro===`dodge`?.34:.62));e===`ember`&&(p.rotation.x=.25,p.rotation.z=t*Math.PI*2,p.rotation.y=t*Math.PI),e===`frost`&&(p.rotation.x=i.acro===`dodge`?.65:.15,p.rotation.z=0,p.rotation.y=i.acro===`dodge`?.3:t*Math.PI*2,p.position.y=i.acro===`dodge`?.7:1),e===`flash`&&(p.rotation.x=.35,p.rotation.z=t*Math.PI*2,p.rotation.y=t*Math.PI*2)}let t=i.acro===`jump`||i.acro===`double`||i.acro===`dodge`,n=i.acro===`land`?Math.sin(Math.min(1,i.acroAge/.24)*Math.PI):0;t&&!i.attack?(d&&(d.rotation.x=-1.2),f&&(f.rotation.x=-1),l&&(l.rotation.x=-1.1,l.rotation.y=.3),u&&(u.rotation.x=-1.05,u.rotation.z=i.acro===`double`?.65:0),a.rotation.y=Math.PI/2-Math.atan2(i.dy,i.dx)):u&&(u.rotation.z=0),m&&(m.rotation.x=t?1.8:n*.75),h&&(h.rotation.x=t?1.65:n*.75),g&&(g.rotation.x=t?-1.4:0),_&&(_.rotation.x=t?-1.2:0),n&&(d&&(d.rotation.x=-n*.6),f&&(f.rotation.x=-n*.6))}if(s){if(s.rotation.x=0,s.rotation.z=0,i.attack&&i.acro===`none`){let e=i.attack,t=Math.min(1,e.age/e.windup),r=Math.max(0,1-(e.age-e.windup)/.35),a=(e.fired?r:-t*.45)*(e.form?n[e.form].range:e.power===2?1.8:e.power?1.4:1);s.rotation.x=-a*(i.role===`fist`?.38:.2),s.position.y-=e.fired?.035:.09*t,(e.form===`breaker`||e.form===`fury`)&&(s.position.y-=Math.abs(a)*.08,s.rotation.x-=a*.18,l&&(l.rotation.z+=a*.3)),e.form===`ward`||e.form===`iron`?(u&&(u.rotation.x=-1.15),d&&(d.rotation.z=.15),f&&(f.rotation.z=-.15)):(d&&(d.rotation.z=0),f&&(f.rotation.z=0)),e.kind===`wave`&&(s.rotation.y=e.fired?-.22:.4*t,u&&(u.rotation.x=e.fired?-1.35:-.65),l&&(l.rotation.x=e.fired?-1.65:-.7)),i.role===`fist`&&e.kind===`slash`&&(u&&(u.rotation.x=(e.stage===2?-1.7:-.75)*Math.abs(a)),l&&(l.rotation.x=(e.stage===2?-.75:-1.7)*Math.abs(a)),s.rotation.y=a*(e.stage===2?-.5:.5)),d&&(d.rotation.x-=a*.35),f&&(f.rotation.x+=a*.25),m&&(m.rotation.x=Math.abs(a)*.5),h&&(h.rotation.x=Math.abs(a)*.25)}i.clash>0||i.countered>0?(s.rotation.x=.28,s.rotation.z=Math.sin(i.clash*70)*.08,l&&(l.rotation.x=-.9)):i.stun>0&&(s.rotation.x=.18+Math.min(1,i.flash/.16)*.16,s.rotation.z=Math.sin(i.angle)*Math.min(1,i.flash/.16)*.1)}if(p&&i.attack?.guardBreak&&i.attack.motion===`kick`){let e=i.attack,t=v(e.age/(e.windup+.24)),n=v(Math.max(0,(e.age-e.windup)/.2));p.position.y=.91+Math.sin(t*Math.PI)*.12,p.rotation.z=Math.sin(t*Math.PI)*.08,s&&(s.rotation.x=-.32*Math.min(1,t)+.18*n,s.rotation.z=-.08*Math.sin(t*Math.PI)),d&&(d.rotation.x=-.35-.85*n),f&&(f.rotation.x=.35+.25*n),m&&(m.rotation.x=.35+1.25*n),h&&(h.rotation.x=.3+.5*n),l&&(l.rotation.x=-.65+.25*n),u&&(u.rotation.x=-.55+.18*n)}if(p&&i.attack&&i.acro===`none`){let e=i.attack,t=v(e.age/(e.windup+(e.heavy||e.stage===5?.4:e.stage===2?.24:.21)));if((e.motion===`step`||e.motion===`advance`)&&(p.position.y-=Math.sin(t*Math.PI)*.1,d&&(d.rotation.x=-Math.sin(t*Math.PI)*.8),f&&(f.rotation.x=Math.sin(t*Math.PI)*.5)),e.motion===`vault`){let t=v(e.age/(7.6/18));p.rotation.x=-Math.sin(t*Math.PI)*.75,p.rotation.y=t*Math.PI*2,d&&(d.rotation.x=-1.1),f&&(f.rotation.x=.65),m&&(m.rotation.x=1.5),u&&(u.rotation.x=-1.3)}e.motion===`turn`&&(p.rotation.y=t*Math.PI*2*(e.shifted?-1:1),u&&(u.rotation.x=-.9),f&&(f.rotation.x=-.6)),e.motion===`roll`&&(p.rotation.x=t*Math.PI*2,p.position.y=.8,m&&(m.rotation.x=1.6),h&&(h.rotation.x=1.6)),e.motion===`kick`&&(p.rotation.y=0,f&&(f.rotation.x=.35+Math.sin(t*Math.PI)*.25))}if(p&&i.attack?.riposte&&(p.position.y=.78,p.rotation.x=.35,s&&(s.rotation.x=-.45),l&&(l.rotation.x=-1.5,l.rotation.y=-.2),u&&(u.rotation.x=.7),d&&(d.rotation.x=-1.1),f&&(f.rotation.x=.8)),p&&i.attack?.dodgeAttack&&!i.attack.aerial){let e=i.attack,t=v(e.age/(e.windup+.3));p.position.y=.8,p.rotation.x=e.heavy?.45:0,p.rotation.y=e.heavy?0:-t*Math.PI*2,s&&(s.rotation.x=-.3,s.rotation.y=e.heavy?-.15:-.5),d&&(d.rotation.x=-1.15),f&&(f.rotation.x=.6),m&&(m.rotation.x=1.6),h&&(h.rotation.x=.35),l&&(l.rotation.x=e.heavy?-1.4:-.4,l.rotation.y=e.heavy?0:(t-.5)*2),u&&(u.rotation.x=-.7,u.rotation.z=-.6)}if(p&&i.attack?.aerial){let e=i.attack,t=v(e.age/(e.windup+.3)),n=e.aerial===`skywave`||e.aerial===`aircut`;p.rotation.x=n?-.25:-.65*Math.sin(t*Math.PI),p.rotation.z=n?Math.sin(t*Math.PI)*.3:0,p.rotation.y=n?t*Math.PI*2:0,s&&(s.rotation.x=n?-.15:-.45,s.rotation.y=n?-.3:.12),d&&(d.rotation.x=-1.15),f&&(f.rotation.x=n?.5:.85),m&&(m.rotation.x=1.65),h&&(h.rotation.x=.35),u&&(u.rotation.x=-.9,u.rotation.z=n?-.7:.35),l&&(l.rotation.x=n?-.4:-1.45,l.rotation.y=n?(t-.4)*2:0),g&&(g.rotation.x=-.5),_&&(_.rotation.x=-.25)}else if(p&&i.z>.2&&(i.acro===`jump`||i.acro===`double`)){let e=v(i.acroAge/.62),t=i.airJumps;t===2&&(p.rotation.z=Math.sin(e*Math.PI)*1.4,u&&(u.rotation.z=-.8)),t===3&&(p.rotation.x=.25,p.rotation.y=e*Math.PI*2,f&&(f.rotation.x=.6),u&&(u.rotation.z=-1)),t>=4&&(p.rotation.x=-e*Math.PI*2,p.rotation.z=0,d&&(d.rotation.x=-.9),f&&(f.rotation.x=-.9),l&&(l.rotation.z=.65),u&&(u.rotation.z=-.65))}if(i.lightCharging&&!i.attack&&i.guard<=0){let e=Math.min(1,i.lightCharge/1.1);s&&(s.rotation.y=-.55,s.rotation.x=-.15,s.position.y-=.1+e*.07),l&&(l.rotation.x=-1.7,l.rotation.y=-.75),u&&(u.rotation.x=-.9),m&&(m.rotation.x=.6),d&&(d.rotation.x=-.5),e>.15&&a.userData.chargeTick!==Math.floor(this.game.time*8)&&(a.userData.chargeTick=Math.floor(this.game.time*8),this.motes(new W(i.x,i.z+1,i.y),16766344,5,.5,.3,-1))}if(i.guard>0||i.guardPulse>0){let e=i.guard>0?Math.min(1,i.guardAge/.09):Math.min(1,i.guardPulse/.25);p&&(p.position.y-=.18*e),s&&(s.rotation.y=-.5*e,s.rotation.x=.15*e),l&&(l.rotation.x=-1.4*e,l.rotation.y=.65*e,l.rotation.z=-.45*e),u&&(u.rotation.x=-1.25*e,u.rotation.z=.5*e),d&&(d.rotation.x=-.55*e,d.rotation.z=.2*e),f&&(f.rotation.x=.3*e,f.rotation.z=-.2*e),m&&(m.rotation.x=.8*e),h&&(h.rotation.x=.45*e)}this.appearances[i.id].update(i,this.game.time),i.hp/i.maxHp<.25&&!i.attack&&i.guard<=0&&i.acro===`none`&&s&&(s.rotation.x+=.12,s.position.y-=.035+Math.sin(this.game.time*5)*.018);let y=i.frozen>0?`water`:i.burning>0?`fire`:i.shocked>0?`metal`:void 0;y&&a.userData.statusTick!==Math.floor(this.game.time*6)&&(a.userData.statusTick=Math.floor(this.game.time*6),this.elemental({kind:`hit`,owner:i.id,x:i.x,y:i.y,z:i.z,angle:this.game.time*3,element:y})),a.traverse(e=>{e instanceof X&&e.material instanceof Xa&&(e.material.emissive.setHex(y?r[y].color:i.guard>0?16768913:i.focus>0?5630667:i.flash>0?11462873:o(i)||i.energy>0?r[t(i)].color:0),e.material.emissiveIntensity=y||i.guard>0?.65:i.focus>0?.6+Math.sin(performance.now()*.012)*.2:i.flash>0?1.5:i.ultimate>0||i.empower>0?.65:/手|小臂|刃|剑|枪|拳/.test(e.name)?i.energy/100*.35:0)});let b=this.shadows[i.id];b.position.set(i.x,.045,i.y),b.scale.setScalar(1+i.z*.18),b.material.opacity=.45/(1+i.z*.5),this.indicators[i.id].position.set(i.x,.048,i.y),this.indicators[i.id].scale.setScalar(i.guard>0?1.5:1),this.indicators[i.id].material.color.setHex(i.guard>0?16768913:i.id===0?Jd:Yd),i.id===1&&this.warning(i,1)}this.blood.update([this.game.player,this.game.enemy],e,this.game.time,this.game.room);let _=this.game.player;this.ghost.visible=this.game.running&&!c,this.ghost.geometry.setFromPoints([new W(_.x,.065,_.y),new W(_.x+Math.cos(this.game.aim)*3,.065,_.y+Math.sin(this.game.aim)*3)]),this.ghost.computeLineDistances();let v=new Set(this.game.supplies.map(e=>e.id));for(let[e,t]of this.supplyMeshes)v.has(e)||(this.scene.remove(t),this.release(t),this.supplyMeshes.delete(e));for(let e of this.game.supplies){let t=this.supplyMeshes.get(e.id);if(!t){t=new Nn;let n=e.kind===`health`?8650665:13015551;if(e.kind===`health`)t.add(this.mesh(new ka(.16,.55,.16),n)),t.add(this.mesh(new ka(.5,.16,.16),n));else{let e=this.mesh(new Fa(.32),n);e.scale.y=1.5,t.add(e)}let r=this.mesh(new La(.42,.48,40),n,.55);r.rotation.x=-Math.PI/2,r.position.y=-.35,t.add(r),this.scene.add(t),this.supplyMeshes.set(e.id,t)}t.position.set(e.x,.65+Math.sin(this.game.time*3+e.id)*.09,e.y),t.rotation.y=this.game.time*.7,t.visible=e.life>3||Math.sin(this.game.time*12)>0}let y=new Set(this.game.shots.map(e=>e.id));for(let[e,t]of this.projectiles)y.has(e)||(this.scene.remove(t),this.release(t),this.projectiles.delete(e));for(let e of this.game.shots){let t=this.projectiles.get(e.id);if(!t){t=new Nn;let i=e.style||`sword`,a=e.element&&e.element!==`none`?r[e.element].color:e.form?n[e.form].tint:e.power?15188735:e.owner===1?Yd:i===`sword`?Jd:i===`spear`?16767111:i===`fist`?15314533:12299263;if(i===`sword`)t.add(this.bladeTrail(.68,-1.25,2.5,a));else if(i===`spear`){let e=this.mesh(new Ma(.16,1.45,8),a);e.rotation.z=-Math.PI/2,t.add(e)}else if(i===`fist`){let e=this.mesh(new za(.66,.12,6,24),a);e.rotation.y=Math.PI/2,t.add(e);let n=this.mesh(new Ra(.4,10,8),a,.45);n.scale.x=.4,t.add(n)}else{let e=this.mesh(new Fa(.24),a);e.scale.set(2.1,.3,.65),t.add(e)}for(let e=1;e<=3;e++){let n=this.mesh(new Ra(.1,6,4),a,.45/e);n.position.x=-e*.3,n.scale.set(2,.6,1),t.add(n)}e.power&&t.scale.setScalar(1.35),this.scene.add(t),this.projectiles.set(e.id,t)}t.position.set(e.x,e.z,e.y),t.rotation.y=-Math.atan2(e.dy,e.dx)}for(let t of this.effects){t.life-=e;let n=Math.max(0,t.life/t.max);if(t.kind===`damage-label`){let e=140*(this.camera.top-this.camera.bottom)/this.camera.zoom/this.height;t.object.scale.set(e,e*144/384,1)}if(t.kind===`motes`&&t.object instanceof Sa){let r=t.object.geometry.getAttribute(`position`),i=t.object.userData.velocities;for(let n=0;n<r.count;n++)i[n*3]*=Math.exp(-2*e),i[n*3+2]*=Math.exp(-2*e),i[n*3+1]-=e*t.object.userData.gravity,r.setXYZ(n,r.getX(n)+i[n*3]*e,r.getY(n)+i[n*3+1]*e,r.getZ(n)+i[n*3+2]*e);r.needsUpdate=!0,t.object.material.size=2.6*(.35+.65*n)}t.velocity&&(t.object.position.addScaledVector(t.velocity,e),t.kind===`afterimage`?t.velocity.multiplyScalar(Math.exp(-4*e)):t.kind!==`damage-label`&&(t.velocity.y-=e*9,t.object.rotation.z+=e*2)),t.kind===`slash`&&(t.object.rotation.y+=(t.object.userData.spin||0)*e),t.kind===`ring`&&t.object.scale.setScalar(1+(1-n)*2),t.kind===`impact-rays`&&t.object.scale.setScalar(1+(1-n)*1.5),t.object.traverse(e=>{if(e instanceof X||e instanceof da||e instanceof Sa||e instanceof ti){let r=e.material;e.userData.fxOpacity??=r.opacity,r.opacity=e.userData.fxOpacity*(t.kind===`damage-label`?Math.min(1,n*2):n*n)}}),t.life<=0&&(this.scene.remove(t.object),this.release(t.object))}if(this.effects=this.effects.filter(e=>e.life>0),this.renderer.render(this.scene,this.camera),this.recordingCanvas){let e=this.recordingCanvas.getContext(`2d`);e.fillStyle=`#101c22`,e.fillRect(0,0,1280,720);let t=Math.min(1280/this.width,720/this.height),n=this.width*t,r=this.height*t;e.drawImage(this.renderer.domElement,(1280-n)/2,(720-r)/2,n,r),e.fillStyle=`#101c22dd`,e.fillRect(0,0,1280,75),e.fillRect(0,650,1280,70),e.fillStyle=`#e5d2a5`,e.font=`28px serif`,e.fillText(`照影 · 剑枪试炼`,32,45),e.font=`16px sans-serif`,e.fillStyle=`#b2cabe`,e.fillText(`自动操作演示 · 实际运行画面`,930,43);let i=this.game;e.fillStyle=`#89e8cf`,e.fillText(`游剑  ${Math.ceil(i.player.hp)}/${i.player.maxHp}`,340,42),e.fillRect(455,29,i.player.hp/i.player.maxHp*120,10),e.fillStyle=`#e4947a`,e.fillText(`长枪  ${Math.ceil(i.enemy.hp)}/${i.enemy.maxHp}`,625,42),e.fillRect(745,29,i.enemy.hp/i.enemy.maxHp*120,10),e.fillStyle=`#e5d2a5`,e.font=`20px sans-serif`,e.fillText(i.player.z>.15?`凌空跃步 · 越过低招`:i.player.guard>0?`回锋招架 · 等待来招`:i.player.attack?.kind===`wave`?`掠影剑气 · 预判命中`:i.player.attack?.kind===`slash`?`连段 `+i.player.chain+` · `+({LLL:`破势突刺`,LLR:`挑月剑`,LRL:`回旋斩`,RLL:`进身刺`}[i.player.chain]||`轻重交替`):`走位试探 · 剑与枪`,32,692),e.fillStyle=`#a9c8b9`,e.font=`16px monospace`,e.fillText(`Z ${i.player.z.toFixed(2)} m   耐力 ${Math.floor(i.player.stamina)}   拆招 ${i.blocks}   避招 ${i.evades}`,820,690)}}release(e){e.traverse(e=>{if(e instanceof ti)e.material.map?.dispose(),e.material.dispose();else if(e instanceof X||e instanceof da||e instanceof Sa){e.geometry.dispose();for(let t of Array.isArray(e.material)?e.material:[e.material])t.dispose()}})}dispose(){this.disposed=!0,window.clearTimeout(this.recordingTimer),this.recorder?.state===`recording`&&this.recorder.stop(),this.release(this.scene);for(let e of this.roleModels)for(let t of Object.values(e))this.release(t);this.particleTexture?.dispose(),this.renderer.dispose(),this.renderer.domElement.remove(),this.audio?.close()}};export{Xd as ArenaView};