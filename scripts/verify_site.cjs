...
(async () => {
  ...
  await page.evaluate(()=>{window.languageState={motion:document.querySelector('.hero-motion'),particle:document.querySelector('[data-kind]'),version:document.querySelector('.hero-motion').dataset.disorderVersion};});
  ...
  check(await page.evaluate(()=>languageState.motion===document.querySelector('.hero-motion')&&languageState.particle.isConnected&&languageState.version===document.querySelector('.hero-motion').dataset.disorderVersion),'Language switch restarted the simulation');
  check(await page.locator('.field-toggle').isVisible(),'Field controls button disappeared after switching to Chinese');
  ...
  check(await page.locator('.field-toggle').isVisible(),'Field controls button disappeared after switching to English');
